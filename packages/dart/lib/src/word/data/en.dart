...
final WordLanguageData en = WordLanguageData(
  ...
  nouns: {
    ...
    WordTheme.object: words(r'''
      ...
      Spindle Sail Anchor Beacon Tent
      Backpack Bedroll Torch Matchbox Candle Flowerpot Kettle Teacup Spoon Plate
      Saucepan Hatchet Handsaw Cogwheel Mainspring Magnet Ribbon Envelope
      ...
      Book Pen Crayon Glue Tape Stamp Sticker Map Diary Wallet Purse Fork Bowl Mug Tray Chopsticks
      Napkin Doorknob Binoculars Souvenir Necklace Earring Bracelet Ring Flag
    '''),
    WordTheme.nature: words(r'''
      ...
      Woodland Grassland Dune Mud Soil Dust Cave Peak Summit Ridge Slope Riverbank Rapids Whirlpool
      Current Foam Surf Iceberg Lava Magma Flame Fire Spark Glow Wildfire Flood Landslide Tsunami
      Eruption Tremor Ripple Darkness Grove
    '''),
    ...
    WordTheme.gem: words(r'''
      ...
      Lithium
      Stone Rock Gravel Aluminum Lead Mercury Uranium Silicon Sulfur Carbon Magnesium Calcium Sodium
      Potassium Jewel Bead Rhinestone Cameo Pumice Shale Rubble Concrete Cement Glass Ceramic Chrome
      Plutonium Radium
    '''),
    WordTheme.concept: words(r'''
      ...
      Idea Thought Dream Plan Rule Law Duty Honor Fame Glory Fate Destiny Luck Belief Opinion Theory
      Proof Evidence Knowledge Science Art Poetry Novel Joke Mystery Clue Lesson Skill Talent Virtue
      Victory Purpose Meaning Beauty Miracle Wish Chaos Progress
    '''),
    ...
    WordTheme.job: words(r'''
      ...
      Brewer
      Butcher Barber Plumber Electrician Mechanic Driver Lawyer Judge Dentist Scientist Programmer
      Designer Architect Accountant Astronaut
    '''),
    ...
    WordTheme.place: words(r'''
      ...
      Bedroom Hallway Staircase Corridor Tunnel Overpass Byway Boardwalk Promenade
      ...
      Keep Bazaar Marketplace Emporium Warehouse Depot Terminal Quay Jetty Harborside
      ...
      Quarry Hollow
      House School Hospital Church Castle Farm Park Shop Office Hotel Restaurant Cafe Zoo Street
      Town
    '''),
    WordTheme.food: words(r'''
      ...
      Egg Soup Cake Pie Cherry Onion Tomato Bean Butter Jam Sauce Flour Sugar Salt Dough Beef Pork
      Broth Peanut
    '''),
    WordTheme.sport: words(r'''
      ...
      Grandstand Pommel
      Race Match Goal Team Net Court Rink Tackle Umpire Tournament League Striker Goalkeeper Barbell
      Dumbbell Treadmill Yoga Sumo Fishing Hiking Surfboard Pingpong Dodgeball Shuttlecock
    '''),
    WordTheme.vehicle: words(r'''
      ...
      Sailplane Autogyro Tiltrotor Stagecoach Halftrack Snowcat Trolleybus Railbus
      Train Ship Van Canoe Lifeboat Rowboat Motorboat Jetski Wheelchair Stroller Wheelbarrow Tank
      Tandem Destroyer Battleship Aircraft Excavator Steamroller
    '''),
    WordTheme.product: words(r'''
      ...
      Steamer Dishwasher Dryer Hairdryer Lotion Sunscreen Doorbell
      ...
      Shredder Smartwatch Cartridge Thermometer Toothpaste Floss Soap Deodorant Mouthwash Tissue
      Diaper Cologne Mascara Eyeliner Moisturizer Cleanser Serum Comb Tweezers Sponge Mop Dustpan
      Duster Trashcan Suitcase Briefcase Handbag Sunglasses Lawnmower Sprinkler Hose Generator
      Bleach Alarm Stereo Camcorder Tripod Lens
    '''),
    WordTheme.color: words(r'''
      Crimson Scarlet Vermilion Carmine Magenta Fuchsia Cerise Blush Apricot Tangerine
      Ocher Umber Sepia Mustard Chartreuse Lime Mint Teal Aqua Cyan Azure Navy Indigo
      ...
      Ginger Ultramarine Viridian Bister Fawn Buff Ecru Oatmeal Porcelain Bone Smoke
      ...
      Red Blue Yellow Orange Black Pink Purple Tan Mahogany Rouge Cardinal Cornflower Claret Oxblood
      Gunmetal Hue Tint Pastel Pigment Dye
    '''),
    WordTheme.finance: words(r'''
      ...
      Deficit Debt Credit Debit Check Currency Exchange Yield Portfolio Escrow Levy
      ...
      Turnover Markup Discount Installment Arrears
      Money Cash Coin Cost Fee Tax Toll Rent Fund Stock Trade Investment Investor Income Earnings
      Payment Purchase Sale Bargain Auction Bid Tip Wealth Poverty Treasure Jackpot Lottery Wager
      Insurance Banknote Paycheck Dollar Penny Fortune
    '''),
    WordTheme.tech: words(r'''
      ...
      Downlink Routing Switching Bridging Tunneling Multicast Broadcast Datagram
      Bootloader Filesystem Partition Directory Symlink Checkpoint Rollback Migration
      Software Hardware Program Code App Website Browser Database Network Internet Email Password
      Login Download Upload Virus Malware Robot Algorithm Function Variable Loop Script Module Icon
      Menu Screen Byte Chip Processor Circuit Sensor Antenna Command Link Domain Emoji
    '''),
    ...
    WordTheme.space: words(r'''
      ...
      Solarsail Starburst
      Sun Earth Mars Venus Jupiter Saturn Neptune Uranus Pluto Zodiac Spacewalk Launchpad Liftoff
      Probe Orbiter Capsule Wormhole Supergiant Magnetar Photon Radiation Moonrock Moondust Moonwalk
      Moonlight Airlock Solarwind Starchart Astrology Protostar
    '''),
    WordTheme.time: words(r'''
      ...
      Heyday Dayspring Nightwatch Eventide Forenoon Gloaming Nightlong Sennight
      Hereafter Nowadays Bygone Yesteryear Prime Vesper Springtide Harvesttime
      Wintertide Autumntide
      Hour Minute Second Day Week Month Year Spring Monday Tuesday Wednesday Thursday Friday
      Saturday Sunday January February April June July August September October November December
      Anniversary Birthday Deadline Schedule Curfew Bedtime Lunchtime Dinnertime Vacation Future Age
      Generation Tonight Rushhour Countdown Daylight
    '''),
    WordTheme.emotion: words(r'''
      ...
      Terror Panic Rage Wrath Irritation Annoyance Boredom Apathy Zeal Ardor Fervor
      ...
      Rancor Malice Spite Contentment Solace Ecstasy Anguish Torment Wistfulness
      Love Hate Happiness Stress Tension Frustration Disgust Admiration Respect Devotion Heartbreak
      Optimism Pessimism Enthusiasm Amusement Impatience Resentment Bitterness Revenge Misery
      Distress Agony Thrill Shyness Loyalty Honesty Generosity Arrogance Ambition
    '''),
    WordTheme.body: words(r'''
      ...
      Arm Leg Hand Foot Face Eye Mouth Back Sole Throat Armpit Pupil Molar Windpipe Pelvis Tailbone
      Biceps Skeleton Gland Cell Tonsil Appendix Scalp Womb Birthmark Pimple Scab Wound
    '''),
    WordTheme.clothing: words(r'''
      Glove Scarf Espadrille Brogue Bathrobe Coat Overcoat Jacket Blazer Shirt Blouse
      Tunic Trousers Jeans Shorts Skirt Dress Gown Vest Cardigan Sweater Jumper Hoodie
      Sock Stocking Tights Underwear Pajamas Apron Bandana Kerchief Necktie Bowtie Belt
      ...
      Suit Tuxedo Jersey Sweatshirt Leggings Bikini Mask Tiara Wig Spacesuit Lifejacket Pocket Hood
      Shoelace Beanie Hijab Sari Kilt Tutu Leotard Tracksuit Jumpsuit Lace Nylon Cashmere Suede Fur
      Tartan
    '''),
    WordTheme.tool: words(r'''
      ...
      Pickaxe Sickle Scythe Hoe Plow Rake Spanner Screwdriver Soldering Tapemeasure
      ...
      Divider Setsquare Tsquare Bevel Jointer Miter Vice Workbench Clawhammer Ballpeen
      Axe Saw Hacksaw Yardstick Screwjack Pincer Bradawl Scraper Burnisher Drawknife
      Spokeshave Miterbox Nailset Plumbbob Pipewrench Boltcutter
      Knife Nail Hook Peg Pitchfork Shears Clippers Pruner Machete Cleaver Mortar Pestle Funnel
      Spatula Blowtorch Sawhorse Ratchet Multitool Boxcutter Crucible Staple Drillbit Wirecutter
      Paintbrush Stencil Winch Hoist Mattock Auger
    '''),
    WordTheme.drink: words(r'''
      ...
      Stout Pilsner Beer Sherry Port Vermouth Whiskey Brandy Vodka Rum Tequila Gin Sake
    ...
    WordTheme.toy: words(r'''
      ...
      Boomerang Chess Checkers Domino Backgammon Bingo Poker Solitaire Charades Hopscotch Peekaboo
      Leapfrog Hangman Tictactoe Sudoku Crossword Trivia Mahjong Roulette Pinata Slide Swing Seesaw
      Carousel Sandpit Sandcastle Trampoline Dollhouse Puppet Marionette Rattle Hobbyhorse Pogostick
      Stilts Jumprope Hulahoop Pinwheel Whirligig Figurine Spinner Snowglobe Bubble Slingshot
      Pinball Foosball Origami Rubberduck Trainset Toysoldier Glowstick Sparkler Confetti
    '''),
    WordTheme.sound: words(r'''
      Sound Noise Voice Silence Tone Whisper Murmur Shout Yell Scream Shriek Screech Cry Sob Wail
      Whimper Sigh Gasp Groan Moan Grunt Snort Laughter Giggle Chuckle Cackle Hum Buzz Hiss Rustle
      Whir Roar Growl Howl Snarl Woof Purr Meow Moo Oink Quack Cluck Neigh Bleat Croak Ribbit Squeak
      Squeal Tweet Chirp Trill Warble Coo Caw Hoot Yodel Rumble Thud Thump Bang Boom Crash Clang
      Clatter Clink Jingle Ding Peal Beep Honk Click Tick Knock Patter Footstep Thunderclap Applause
      Clap Hiccup Sneeze Cough Yawn Burp Snore Babble Chatter Mumble Splash Plop Crunch Crackle
      Sizzle Fizz Pop Whoosh Swish Ping Zap Drip Trickle Gurgle Twang Static Din Clamor Uproar
      Hubbub Commotion
    '''),
    WordTheme.person: words(r'''
      Person Human Child Baby Newborn Toddler Kid Boy Girl Teenager Youngster Adult Elder Man Woman
      Lady Gentleman Mother Father Parent Son Daughter Brother Sister Sibling Twin Grandmother
      Grandfather Grandchild Uncle Aunt Nephew Niece Cousin Husband Wife Bride Groom Widow Orphan
      Ancestor Relative Neighbor Friend Companion Rival Enemy Stranger Guest Host Visitor Newcomer
      Villager Citizen Roommate Classmate Teammate Playmate Spectator Bystander Passerby Witness
      Customer Patient Passenger Tourist Nomad Pioneer Hermit Loner Outcast Refugee Outlaw Prisoner
      Beggar Hero Heroine Villain Rascal Prankster Sleepyhead Bookworm Daydreamer Dreamer Genius
      Fool Coward Bully Brat Crybaby Tattletale Braggart Chatterbox Gossip Grouch Optimist Pessimist
      Romantic Rebel Leader Boss Veteran Beginner Expert Winner Loser Volunteer Lad Lass Maiden
      Daredevil Sleepwalker Castaway Sweetheart
    '''),
    WordTheme.furniture: words(r'''
      Cushion Quilt Mattress Curtain Wardrobe Bookshelf Nightstand Recliner Beanbag Footstool
      Ottoman Bedframe Duvet Bedsheet Pillowcase Chair Desk Bed Sofa Table Stool Bench Shelf Drawer
      Cradle Crib Cot Hammock Rug Carpet Blanket Pillow Bolster Lampshade Chandelier Sconce
      Candlestick Candelabra Vase Urn Frame Cabinet Cupboard Dresser Bureau Sideboard Armchair
      Rocker Loveseat Futon Daybed Bunkbed Headboard Bedpost Bedspread Tablecloth Doily Rack
      Hatstand Mantelpiece Bookend Toybox Hamper Shutter Valance Tapestry Wallpaper Highchair
      Playpen Bassinet Divan Armoire Pew Throne Locker
    '''),
  },
  parts: words(r'''
  ...
  levels: WordLevels(
    basic: words(r'''
      ...
      Toy Game Doll Teddybear Ball Yoyo Frisbee Chess Checkers Domino Bingo Poker Hopscotch Peekaboo
      Slide Swing Seesaw Carousel Sandcastle Trampoline Dollhouse Puppet Rattle Jumprope Hulahoop
      Bubble Sound Noise Voice Silence Whisper Shout Yell Scream Cry Sigh Laughter Giggle Hum Buzz
      Roar Woof Meow Moo Oink Quack Squeak Bang Boom Crash Beep Honk Click Knock Applause Clap
      Hiccup Sneeze Cough Yawn Burp Snore Splash Pop Drip Person Human Child Baby Toddler Kid Boy
      Girl Teenager Adult Man Woman Lady Gentleman Mother Father Parent Son Daughter Brother Sister
      Twin Grandmother Grandfather Uncle Aunt Nephew Niece Cousin Husband Wife Bride Groom Neighbor
      Friend Enemy Stranger Guest Visitor Customer Patient Passenger Tourist Hero Villain Genius
      Fool Bully Leader Boss Winner Loser Chair Desk Bed Sofa Table Stool Bench Shelf Drawer Crib
      Hammock Rug Carpet Blanket Pillow Lampshade Vase Frame Cabinet Cupboard Dresser Armchair
      Wardrobe Toybox Wallpaper
      Dog Cow Pig Sheep Goat Mouse Rat Hamster Chicken Crow Pigeon Kangaroo Crocodile Lobster
      Mosquito Book Pen Crayon Glue Tape Stamp Sticker Map Diary Wallet Purse Fork Bowl Mug Tray
      Chopsticks Napkin Necklace Earring Bracelet Ring Flag Hill Valley Cliff Island Beach Shore
      Coast Stream Pond Puddle Jungle Mud Soil Dust Cave Peak Fire Flame Flood Darkness Grass Tree
      Flower Root Seed Weed Bush Branch Thorn Stone Rock Gravel Lead Jewel Bead Concrete Cement
      Glass Idea Thought Dream Plan Goal Rule Law Luck Opinion Science Art Novel Joke Mystery Clue
      Lesson Skill Talent Victory Beauty Wish Monster Giant Beast Spirit Wand Magic Butcher Barber
      Plumber Mechanic Driver Lawyer Judge Dentist Scientist Programmer Designer Architect Astronaut
      Song Tune Note Concert Band Opera Jazz House School Hospital Church Castle Farm Park Shop
      Office Hotel Restaurant Cafe Zoo Street Town Egg Soup Cake Pie Cherry Onion Tomato Bean Butter
      Jam Sauce Flour Sugar Salt Beef Pork Peanut Race Match Goal Team Net Court Goalkeeper Yoga
      Fishing Hiking Pingpong Train Ship Van Canoe Wheelchair Stroller Wheelbarrow Tank Telephone
      Headset Cable Plug Stove Freezer Mixer Toothpaste Soap Tissue Diaper Comb Sponge Mop Suitcase
      Handbag Sunglasses Hose Alarm Red Blue Yellow Orange Black Pink Purple Money Cash Coin Cost
      Fee Tax Rent Income Payment Sale Tip Treasure Lottery Dollar Penny Software Program Code App
      Website Browser Network Internet Email Password Login Download Upload Virus Robot Icon Menu
      Screen Chip Link Emoji Wind Storm Fog Hail Heat Dew Snowfall Temperature Sun Earth Mars Venus
      Jupiter Saturn Pluto Moonlight Hour Minute Second Day Week Month Year Spring Monday Tuesday
      Wednesday Thursday Friday Saturday Sunday January February April June July August September
      October November December Birthday Bedtime Lunchtime Vacation Future Age Tonight Love Hate
      Happiness Stress Respect Revenge Shyness Loyalty Honesty Arm Leg Hand Foot Face Eye Mouth Back
      Throat Armpit Skeleton Pimple Wound Suit Jersey Sweatshirt Leggings Bikini Mask Wig Pocket
      Hood Shoelace Beanie Fur Knife Nail Hook Peg Shears Funnel Spatula Paintbrush Cola Cognac Soju
      Rootbeer Boba Decaf Slushie Liquor
    '''),
    rare: words(r'''
      ...
      Figurine Snowglobe Foosball Origami Toysoldier Glowstick Murmur Shriek Screech Whimper Cackle
      Whir Snarl Bleat Ribbit Trill Warble Caw Yodel Clang Clatter Clink Peal Patter Thunderclap
      Babble Plop Crackle Gurgle Twang Static Din Clamor Uproar Hubbub Commotion Newborn Youngster
      Sibling Grandchild Ancestor Companion Villager Citizen Spectator Bystander Passerby Nomad
      Pioneer Hermit Outcast Refugee Outlaw Heroine Rascal Prankster Braggart Grouch Optimist
      Pessimist Veteran Lad Lass Maiden Daredevil Sleepwalker Castaway Cot Bolster Sconce
      Candlestick Candelabra Urn Bureau Sideboard Loveseat Futon Daybed Headboard Bedpost Bedspread
      Doily Hatstand Mantelpiece Bookend Valance Tapestry Bassinet Divan Armoire Pew
      Binoculars Souvenir Bog Magma Tremor Eruption Stump Uranium Silicon Sulfur Magnesium Potassium
      Rhinestone Cameo Pumice Shale Plutonium Radium Virtue Chaos Ghoul Leprechaun Gremlin Sasquatch
      Hellhound Elixir Jinx Electrician Accountant Lyric Gong Bongo Kazoo Broth Dough Rink Umpire
      Striker Barbell Dumbbell Sumo Shuttlecock Jetski Tandem Destroyer Excavator Steamroller Copier
      Shredder Cartridge Cologne Mascara Eyeliner Moisturizer Cleanser Serum Tweezers Duster
      Camcorder Tripod Mahogany Rouge Cardinal Cornflower Claret Oxblood Gunmetal Hue Tint Pastel
      Pigment Investor Earnings Wager Banknote Paycheck Malware Algorithm Variable Module Processor
      Circuit Sensor Antenna Domain Thunderbolt Waterspout Firestorm Vapor Ozone Zodiac Orbiter
      Wormhole Supergiant Magnetar Photon Radiation Moonrock Moondust Airlock Solarwind Starchart
      Astrology Protostar Curfew Generation Rushhour Devotion Pessimism Resentment Bitterness Agony
      Arrogance Sole Pupil Molar Windpipe Pelvis Tailbone Biceps Gland Tonsil Appendix Scalp Womb
      Birthmark Scab Tuxedo Tiara Spacesuit Lifejacket Hijab Sari Kilt Tutu Leotard Cashmere Suede
      Tartan Pitchfork Pruner Machete Cleaver Mortar Pestle Blowtorch Sawhorse Ratchet Multitool
      Boxcutter Crucible Drillbit Wirecutter Stencil Winch Hoist Mattock Auger Negroni Grappa
      Schnapps Mezcal Prosecco Merlot Riesling Chianti Kvass Cortado Affogato Rooibos Spritzer
      Mimosa Julep Moonshine Ayran
    '''),
  ),
