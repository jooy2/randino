...
final WordLanguageData vi = WordLanguageData(
  ...
  nouns: <WordTheme, WordPool>{
    ...
    WordTheme.object: words(r'''
      ...
      xúc_xắc thẻ mảnh_ghép buồm neo lều đèn_pin diêm nến chậu ấm chén thìa đĩa nồi
    ...
    WordTheme.product: words(r'''
      ...
      máy_sấy_tóc kem_dưỡng rèm_cửa chuông_cửa nhiệt_kế bình_cứu_hỏa bóng_đèn dây_nối
