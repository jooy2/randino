...
final WordLanguageData vi = WordLanguageData(
  ...
  nouns: <WordTheme, WordPool>{
    WordTheme.animal: words(r'''
      ...
      dơi chồn nhím lạc_đà hà_mã tê_giác hươu_cao_cổ chuột sứa hải_cẩu đà_điểu chim_sẻ
      cá_chép lươn
    '''),
    ...
    WordTheme.nature: words(r'''
      ...
      măng_đá nhũ_đá hang_động gờ_đá bóng vọng hương lửa than_hồng dòng_chảy bờ_biển
      bãi_bồi
    '''),
    ...
    WordTheme.gem: words(r'''
      ...
      bạch_á ngọc_quý mạch_quặng hồng_ngọc lam_ngọc lục_bảo đá_mắt_mèo đá_mặt_trăng
    ...
    WordTheme.myth: words(r'''
      ...
      huyền_vũ cửu_vĩ_hồ chim_lửa người_sói ma_cà_rồng xác_sống ma_nơ_canh người_lùn
    ...
    WordTheme.job: words(r'''
      ...
      thợ_mỏ thợ_mộc thợ_gốm thợ_may tế_sư học_giả tiến_sĩ trọng_tài nghệ_sĩ_xiếc
    '''),
    WordTheme.music: words(r'''
      ...
      khúc_giữa âm_sắc nhịp_phách dàn_nhạc chương_nhạc khúc_mở_màn dạ_khúc khúc_hát_đêm
    ...
    WordTheme.color: words(r'''
      ...
      đen_nhánh đỏ_tươi cam_tươi vàng_tươi xanh_tươi màu_ngọc_lam hổ_phách_sắc đồng_sắc
    ...
    WordTheme.finance: words(r'''
      ...
      quyết_toán rút_quá sao_kê sổ_tiết_kiệm chủ_nợ con_nợ người_đi_vay định_giá
    ...
    WordTheme.tech: words(r'''
      ...
      tên_máy tải_trọng tổng_kiểm lược_đồ bản_sao_lưu cụm_máy phân_mảnh bản_sao ảnh_chụp
    ...
    WordTheme.weather: words(r'''
      ...
      gió_lào mây_đen mây_mưa áp_thấp áp_cao thời_tiết khí_hậu nhiệt_độ độ_ẩm khí_áp
    ...
    WordTheme.space: words(r'''
      ...
      chòm_sao quỹ_đạo trọng_lực tự_quay công_chuyển vết_đen gió_mặt_trời bề_mặt_trăng
    ...
    WordTheme.time: words(r'''
      ...
      hôm_kia một_ngày hai_ngày ba_ngày mười_ngày nửa_tháng một_tháng nửa_năm một_năm
      năm_nay năm_ngoái năm_sau mùa_xuân mùa_hè mùa_thu mùa_đông đầu_xuân cuối_xuân
      đầu_hè giữa_hè cuối_hè đầu_thu cuối_thu đầu_đông giữa_đông cuối_đông tiết_khí
    ...
    WordTheme.tool: words(r'''
      ...
      bừa_đất cối_xay thoi ống_chỉ cán lưỡi_dao bộ_dụng_cụ hộp_đồ_nghề đinh_vít
    ...
    WordTheme.drink: words(r'''
      ...
      mật_ong_pha nước_sâm nước_rau_má nước_vối trà_atisô trà_bí_đao nước_yến
