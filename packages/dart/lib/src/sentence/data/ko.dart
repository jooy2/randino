...
final SentenceLanguageData ko = SentenceLanguageData(
  ...
  verbs: <VerbGroup>[
    ...
    VerbGroup(
      ...
      words: words(r'빛난다 흐른다 저문다 깊어진다 시작된다 끝난다 이어진다 지나간다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'빛납니까 흐릅니까 저뭅니까 깊어집니까 시작됩니까 끝납니까 이어집니까 지나갑니까'),
        PredicateForm.linking: words(r'빛나고 흐르고 저물고 깊어지고 시작되고 끝나고 이어지고 지나가고'),
      },
      past: conjugate(r'빛났 흘렀 저물었 깊어졌 시작됐 끝났 이어졌 지나갔', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
    ...
    VerbGroup(
      ...
      words: words(r'익는다 식는다 끓는다 녹는다 상한다 남는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'익니|익나|익는가 식니|식나|식는가 끓니|끓나|끓는가 녹니|녹나|녹는가 상하니|상하나|상하는가 남니|남나|남는가',
        ),
        PredicateForm.exclamation: words(r'''
      ...
      past: conjugate(r'익었 식었 끓었 녹았 상했 남았', statement: '다', endings: _pastEndings),
    ),
  ],
  states: <StateGroup>[
    StateGroup(
    ...
    StateGroup(
      subject: const <NounClass>[NounClass.edible],
      words: words(r'달다 짜다 맵다 시다 뜨겁다 차갑다 고소하다 담백하다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'다니|단가 짜니|짠가 매우니|매운가 시니|신가 뜨거우니|뜨거운가 차가우니|차가운가 고소하니|고소한가 담백하니|담백한가',
        ),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'답니까 짭니까 맵습니까 십니까 뜨겁습니까 차갑습니까 고소합니까 담백합니까'),
      },
      past: conjugate(r'달았 짰 매웠 셨 뜨거웠 차가웠 고소했 담백했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.idea],
      words: words(r'어렵다 쉽다 분명하다 흐릿하다 영원하다 덧없다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'어려우니|어려운가 쉬우니|쉬운가 분명하니|분명한가 흐릿하니|흐릿한가 영원하니|영원한가 덧없으니|덧없는가'),
        PredicateForm.exclamation: words(r'''
      ...
      past: conjugate(r'어려웠 쉬웠 분명했 흐릿했 영원했 덧없었', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.plant],
