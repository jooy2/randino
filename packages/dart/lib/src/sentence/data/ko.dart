...
final SentenceLanguageData ko = SentenceLanguageData(
  ...
  verbs: <VerbGroup>[
    ...
    VerbGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'먹니 마시니 씹니 삼키니 맛보니 굽니 데우니')},
    ),
    VerbGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
    ...
    VerbGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'만드니 고치니 닦니 파니 사니 손질하니')},
    ),
    VerbGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'꿈꾸니 기억하니 잊니 상상하니 헤아리니')},
    ),
    VerbGroup(
    ...
    VerbGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'자라니 시드니 피어나니 흔들리니 뿌리내리니')},
    ),
    VerbGroup(
      ...
      words: words(r'''
        떨린다 움직인다 저린다 굳는다
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'떨리니 움직이니 저리니 굳니')},
    ),
    VerbGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'익니 식니 끓니 녹니 상하니 남니')},
    ),
  ],
  states: <StateGroup>[
    StateGroup(
    ...
    StateGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'아름답니 낯서니 새롭니 흔하니 드무니')},
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.place, NounClass.event],
      words: words(r'''
    ...
    StateGroup(
      ...
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'어렵니 쉽니 분명하니 흐릿하니 영원하니 덧없니')},
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.plant],
      words: words(r'''
        푸르다 무성하다 향기롭다 시들하다
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'푸르니 무성하니 향기롭니 시들하니')},
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.body],
      words: words(r'''
        따뜻하다 차갑다 아프다 뻣뻣하다
      '''),
      forms: <PredicateForm, WordPool>{PredicateForm.question: words(r'따뜻하니 차갑니 아프니 뻣뻣하니')},
    ),
  ],
  manners: words(r'''
