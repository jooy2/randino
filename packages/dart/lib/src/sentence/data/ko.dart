...
final SentenceLanguageData ko = SentenceLanguageData(
  ...
  verbs: <VerbGroup>[
    VerbGroup(
      ...
      words: words(r'일어난다 일어선다 깨어난다 눈뜬다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'일어나니|일어나나|일어나는가 일어서니|일어서나|일어서는가 깨어나니|깨어나나|깨어나는가 눈뜨니|눈뜨나|눈뜨는가',
        ),
      ...
      past: conjugate(r'일어났 일어섰 깨어났 눈떴', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.go,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
    ...
    VerbGroup(
      field: VerbField.go,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'떠난다 나선다 출발한다 길을떠난다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'떠나니|떠나나|떠나는가 나서니|나서나|나서는가 출발하니|출발하나|출발하는가 길을떠나니|길을떠나나|길을떠나는가',
        ),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'떠났 나섰 출발했 길을떠났', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.arrive,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      requires: SentenceSlot.destination,
      words: words(r'들어온다 닿는다 이른다 다다른다 들어선다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'들어오니|들어오나|들어오는가 닿니|닿나|닿는가 이르니|이르나|이르는가 다다르니|다다르나|다다르는가 들어서니|들어서나|들어서는가',
        ),
      ...
      past: conjugate(r'들어왔 닿았 이르렀 다다랐 들어섰', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.arrive,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'돌아온다 도착한다 돌아간다 귀가한다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'돌아오니|돌아오나|돌아오는가 도착하니|도착하나|도착하는가 돌아가니|돌아가나|돌아가는가 귀가하니|귀가하나|귀가하는가',
        ),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'돌아왔 도착했 돌아갔 귀가했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.move,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      subjectWithout: const <NounTrait>[NounTrait.swimmer, NounTrait.crawler],
      words: words(r'달린다 걷는다 뛴다 서성인다 지나간다 어슬렁댄다 뛰어다닌다 거닌다 산책한다'),
      forms: <PredicateForm, WordPool>{
        ...
        '''),
        PredicateForm.casual: words(r'달려 걸어 뛰어 서성여 지나가 어슬렁대 뛰어다녀 거닐어 산책해'),
        PredicateForm.casualQuestion: words(r'''
          달려|달리지 걸어|걷지 뛰어|뛰지 서성여|서성이지 지나가|지나가지 어슬렁대|어슬렁대지 뛰어다녀|뛰어다니지 거닐어|거닐지 산책해|산책하지
        '''),
        PredicateForm.polite: words(r'달려요 걸어요 뛰어요 서성여요 지나가요 어슬렁대요 뛰어다녀요 거닐어요 산책해요'),
        PredicateForm.politeQuestion: words(r'''
          달려요|달리죠 걸어요|걷죠 뛰어요|뛰죠 서성여요|서성이죠 지나가요|지나가죠 어슬렁대요|어슬렁대죠 뛰어다녀요|뛰어다니죠 거닐어요|거닐죠 산책해요|산책하죠
        '''),
        PredicateForm.formal: words(r'달립니다 걷습니다 뜁니다 서성입니다 지나갑니다 어슬렁댑니다 뛰어다닙니다 거닙니다 산책합니다'),
        PredicateForm.formalQuestion: words(r'달립니까 걷습니까 뜁니까 서성입니까 지나갑니까 어슬렁댑니까 뛰어다닙니까 거닙니까 산책합니까'),
        PredicateForm.linking: words(r'달리고 걷고 뛰고 서성이고 지나가고 어슬렁대고 뛰어다니고 거닐고 산책하고'),
      },
      past: conjugate(r'달렸 걸었 뛰었 서성였 지나갔 어슬렁댔 뛰어다녔 거닐었 산책했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.move,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
    ...
    VerbGroup(
      ...
      words: words(r'기어간다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'기어가니|기어가나|기어가는가'),
        PredicateForm.exclamation: words(r'기어가는구나|기어가네|기어가는군'),
        PredicateForm.casual: words(r'기어가'),
        PredicateForm.casualQuestion: words(r'기어가|기어가지'),
        PredicateForm.polite: words(r'기어가요'),
        PredicateForm.politeQuestion: words(r'기어가요|기어가죠'),
        PredicateForm.formal: words(r'기어갑니다'),
        PredicateForm.formalQuestion: words(r'기어갑니까'),
        PredicateForm.linking: words(r'기어가고'),
      },
      past: conjugate(r'기어갔', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.move,
    ...
    VerbGroup(
      ...
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'기다린다 두리번거린다 숨는다 뒤척인다 머뭇거린다 기웃거린다 멈춘다 멈춰선다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
          기다리니|기다리나|기다리는가 두리번거리니|두리번거리나|두리번거리는가 숨니|숨나|숨는가 뒤척이니|뒤척이나|뒤척이는가 머뭇거리니|머뭇거리나|머뭇거리는가
          기웃거리니|기웃거리나|기웃거리는가 멈추니|멈추나|멈추는가 멈춰서니|멈춰서나|멈춰서는가
        '''),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'기다립니까 두리번거립니까 숨습니까 뒤척입니까 머뭇거립니까 기웃거립니까 멈춥니까 멈춰섭니까'),
        PredicateForm.linking: words(r'기다리고 두리번거리고 숨고 뒤척이고 머뭇거리고 기웃거리고 멈추고 멈춰서고'),
      },
      past: conjugate(r'기다렸 두리번거렸 숨었 뒤척였 머뭇거렸 기웃거렸 멈췄 멈춰섰', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
    ...
    VerbGroup(
      ...
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'잠잔다 잠든다 존다 꾸벅인다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'잠자니|잠자나|잠자는가 잠드니|잠드나|잠드는가 조니|조나|조는가 꾸벅이니|꾸벅이나|꾸벅이는가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'잠잤 잠들었 졸았 꾸벅였', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.express,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'웃는다 운다 하품한다 한숨짓는다 미소짓는다 콧노래한다 중얼거린다 소리친다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
          웃니|웃나|웃는가 우니|우나|우는가 하품하니|하품하나|하품하는가 한숨짓니|한숨짓나|한숨짓는가 미소짓니|미소짓나|미소짓는가 콧노래하니|콧노래하나|콧노래하는가
          중얼거리니|중얼거리나|중얼거리는가 소리치니|소리치나|소리치는가
        '''),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'웃습니까 웁니까 하품합니까 한숨짓습니까 미소짓습니까 콧노래합니까 중얼거립니까 소리칩니까'),
        PredicateForm.linking: words(r'웃고 울고 하품하고 한숨짓고 미소짓고 콧노래하고 중얼거리고 소리치고'),
      },
      past: conjugate(r'웃었 울었 하품했 한숨지었 미소지었 콧노래했 중얼거렸 소리쳤', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.talk,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'이야기한다 수다떤다 대화한다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'이야기하니|이야기하나|이야기하는가 수다떠니|수다떠나|수다떠는가 대화하니|대화하나|대화하는가'),
        PredicateForm.exclamation: words(
          r'이야기하는구나|이야기하네|이야기하는군 수다떠는구나|수다떠네|수다떠는군 대화하는구나|대화하네|대화하는군',
        ),
        PredicateForm.casual: words(r'이야기해 수다떨어 대화해'),
        PredicateForm.casualQuestion: words(r'이야기해|이야기하지 수다떨어|수다떨지 대화해|대화하지'),
        PredicateForm.polite: words(r'이야기해요 수다떨어요 대화해요'),
        PredicateForm.politeQuestion: words(r'이야기해요|이야기하죠 수다떨어요|수다떨죠 대화해요|대화하죠'),
        PredicateForm.formal: words(r'이야기합니다 수다떱니다 대화합니다'),
        PredicateForm.formalQuestion: words(r'이야기합니까 수다떱니까 대화합니까'),
        PredicateForm.linking: words(r'이야기하고 수다떨고 대화하고'),
      },
      past: conjugate(r'이야기했 수다떨었 대화했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.play,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'춤춘다 노래한다 뒹군다 뛰논다 장난친다 뛰어오른다 폴짝거린다 구른다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
          춤추니|춤추나|춤추는가 노래하니|노래하나|노래하는가 뒹구니|뒹구나|뒹구는가 뛰노니|뛰노나|뛰노는가 장난치니|장난치나|장난치는가 뛰어오르니|뛰어오르나|뛰어오르는가
          폴짝거리니|폴짝거리나|폴짝거리는가 구르니|구르나|구르는가
        '''),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'춤춥니까 노래합니까 뒹굽니까 뛰놉니까 장난칩니까 뛰어오릅니까 폴짝거립니까 구릅니까'),
        PredicateForm.linking: words(r'춤추고 노래하고 뒹굴고 뛰놀고 장난치고 뛰어오르고 폴짝거리고 구르고'),
      },
      past: conjugate(r'춤췄 노래했 뒹굴었 뛰놀았 장난쳤 뛰어올랐 폴짝거렸 굴렀', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'꿈꾼다 기억한다 잊는다 상상한다 헤아린다 떠올린다 그리워한다 궁금해한다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
          꿈꾸니|꿈꾸나|꿈꾸는가 기억하니|기억하나|기억하는가 잊니|잊나|잊는가 상상하니|상상하나|상상하는가 헤아리니|헤아리나|헤아리는가 떠올리니|떠올리나|떠올리는가
          그리워하니|그리워하나|그리워하는가 궁금해하니|궁금해하나|궁금해하는가
        '''),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'꿈꿉니까 기억합니까 잊습니까 상상합니까 헤아립니까 떠올립니까 그리워합니까 궁금해합니까'),
        PredicateForm.linking: words(r'꿈꾸고 기억하고 잊고 상상하고 헤아리고 떠올리고 그리워하고 궁금해하고'),
      },
      past: conjugate(r'꿈꿨 기억했 잊었 상상했 헤아렸 떠올렸 그리워했 궁금해했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.formalQuestion: words(r'봅니까 바라봅니까 살핍니까 들여다봅니까 구경합니까 만집니까 쓰다듬습니까 지켜봅니까'),
        PredicateForm.linking: words(r'보고 바라보고 살피고 들여다보고 구경하고 만지고 쓰다듬고 지켜보고'),
      },
      past: conjugate(r'봤 바라봤 살폈 들여다봤 구경했 만졌 쓰다듬었 지켜봤', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.search,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'찾아다닌다 헤맨다 둘러본다 살펴본다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'찾아다니니|찾아다니나|찾아다니는가 헤매니|헤매나|헤매는가 둘러보니|둘러보나|둘러보는가 살펴보니|살펴보나|살펴보는가',
        ),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'찾아다녔 헤맸 둘러봤 살펴봤', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'찾는다 발견한다 줍는다 찾아낸다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'찾니|찾나|찾는가 발견하니|발견하나|발견하는가 줍니|줍나|줍는가 찾아내니|찾아내나|찾아내는가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'찾았 발견했 주웠 찾아냈', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'챙긴다 고른다 집는다 얻는다 받는다 꺼낸다 움켜쥔다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'챙겼 골랐 집었 얻었 받았 꺼냈 움켜쥐었', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'옮긴다 나른다 가져온다 들고온다 안고온다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'옮겼 날랐 가져왔 들고왔 안고왔', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'감춘다 숨긴다 넣어둔다 간직한다 묻는다 챙겨둔다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'감췄 숨겼 넣어뒀 간직했 묻었 챙겨뒀', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'잃어버린다 떨어뜨린다 놓친다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'잃어버리니|잃어버리나|잃어버리는가 떨어뜨리니|떨어뜨리나|떨어뜨리는가 놓치니|놓치나|놓치는가'),
        PredicateForm.exclamation: words(
          r'잃어버리는구나|잃어버리네|잃어버리는군 떨어뜨리는구나|떨어뜨리네|떨어뜨리는군 놓치는구나|놓치네|놓치는군',
        ),
        PredicateForm.casual: words(r'잃어버려 떨어뜨려 놓쳐'),
        PredicateForm.casualQuestion: words(r'잃어버려|잃어버리지 떨어뜨려|떨어뜨리지 놓쳐|놓치지'),
        PredicateForm.polite: words(r'잃어버려요 떨어뜨려요 놓쳐요'),
        PredicateForm.politeQuestion: words(r'잃어버려요|잃어버리죠 떨어뜨려요|떨어뜨리죠 놓쳐요|놓치죠'),
        PredicateForm.formal: words(r'잃어버립니다 떨어뜨립니다 놓칩니다'),
        PredicateForm.formalQuestion: words(r'잃어버립니까 떨어뜨립니까 놓칩니까'),
        PredicateForm.linking: words(r'잃어버리고 떨어뜨리고 놓치고'),
      },
      past: conjugate(r'잃어버렸 떨어뜨렸 놓쳤', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.meet,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      object: const <NounClass>[NounClass.person],
      words: words(r'만난다 마주친다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'만나니|만나나|만나는가 마주치니|마주치나|마주치는가'),
        PredicateForm.exclamation: words(r'만나는구나|만나네|만나는군 마주치는구나|마주치네|마주치는군'),
        PredicateForm.casual: words(r'만나 마주쳐'),
        PredicateForm.casualQuestion: words(r'만나|만나지 마주쳐|마주치지'),
        PredicateForm.polite: words(r'만나요 마주쳐요'),
        PredicateForm.politeQuestion: words(r'만나요|만나죠 마주쳐요|마주치죠'),
        PredicateForm.formal: words(r'만납니다 마주칩니다'),
        PredicateForm.formalQuestion: words(r'만납니까 마주칩니까'),
        PredicateForm.linking: words(r'만나고 마주치고'),
      },
      past: conjugate(r'만났 마주쳤', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
    ...
    VerbGroup(
      ...
      words: words(r'고친다 닦는다 손질한다 다듬는다 정리한다 매만진다 수리한다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'고칩니까 닦습니까 손질합니까 다듬습니까 정리합니까 매만집니까 수리합니까'),
        PredicateForm.linking: words(r'고치고 닦고 손질하고 다듬고 정리하고 매만지고 수리하고'),
      },
      past: conjugate(r'고쳤 닦았 손질했 다듬었 정리했 매만졌 수리했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'판다 넘긴다 건넨다 내놓는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'파니|파나|파는가 넘기니|넘기나|넘기는가 건네니|건네나|건네는가 내놓니|내놓나|내놓는가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'팔았 넘겼 건넸 내놓았', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.buy,
      subject: const <NounClass>[NounClass.person],
      ...
      words: words(r'산다 사온다 구한다 장만한다 사들인다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'사니|사나|사는가 사오니|사오나|사오는가 구하니|구하나|구하는가 장만하니|장만하나|장만하는가 사들이니|사들이나|사들이는가',
        ),
        PredicateForm.exclamation: words(r'''
      ...
      past: conjugate(r'샀 사왔 구했 장만했 사들였', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'굽는다 데운다 끓인다 요리한다 썬다 담는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'굽니|굽나|굽는가 데우니|데우나|데우는가 끓이니|끓이나|끓이는가 요리하니|요리하나|요리하는가 써니|써나|써는가 담니|담나|담는가',
        ),
        PredicateForm.exclamation: words(r'''
      ...
      past: conjugate(r'구웠 데웠 끓였 요리했 썰었 담았', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.eat,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      object: const <NounClass>[NounClass.edible],
      objectThemes: const <WordTheme>[WordTheme.food],
      words: words(r'먹는다 씹는다 삼킨다 맛본다 베어먹는다 먹어치운다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'먹었 씹었 삼켰 맛봤 베어먹었 먹어치웠', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      ...
      words: words(r'마신다 들이킨다 홀짝인다 음미한다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'마시니|마시나|마시는가 들이키니|들이키나|들이키는가 홀짝이니|홀짝이나|홀짝이는가 음미하니|음미하나|음미하는가',
        ),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'마셨 들이켰 홀짝였 음미했', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.place],
      words: words(r'조용해진다 어두워진다 밝아온다 고요해진다 붐빈다 물든다 환해진다 잠잠해진다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
          조용해지니|조용해지나|조용해지는가 어두워지니|어두워지나|어두워지는가 밝아오니|밝아오나|밝아오는가 고요해지니|고요해지나|고요해지는가 붐비니|붐비나|붐비는가
          물드니|물드나|물드는가 환해지니|환해지나|환해지는가 잠잠해지니|잠잠해지나|잠잠해지는가
        '''),
        PredicateForm.exclamation: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'조용해집니까 어두워집니까 밝아옵니까 고요해집니까 붐빕니까 물듭니까 환해집니까 잠잠해집니까'),
        PredicateForm.linking: words(r'조용해지고 어두워지고 밝아오고 고요해지고 붐비고 물들고 환해지고 잠잠해지고'),
      },
      past: conjugate(r'조용해졌 어두워졌 밝아왔 고요해졌 붐볐 물들었 환해졌 잠잠해졌', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.event],
      words: words(r'흐른다 시작된다 끝난다 이어진다 지나간다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
        ...
        '''),
        PredicateForm.casual: words(r'흘러 시작돼 끝나 이어져 지나가'),
        PredicateForm.casualQuestion: words(r'흘러|흐르지 시작돼|시작되지 끝나|끝나지 이어져|이어지지 지나가|지나가지'),
        PredicateForm.polite: words(r'흘러요 시작돼요 끝나요 이어져요 지나가요'),
        PredicateForm.politeQuestion: words(r'흘러요|흐르죠 시작돼요|시작되죠 끝나요|끝나죠 이어져요|이어지죠 지나가요|지나가죠'),
        PredicateForm.formal: words(r'흐릅니다 시작됩니다 끝납니다 이어집니다 지나갑니다'),
        PredicateForm.formalQuestion: words(r'흐릅니까 시작됩니까 끝납니까 이어집니까 지나갑니까'),
        PredicateForm.linking: words(r'흐르고 시작되고 끝나고 이어지고 지나가고'),
      },
      past: conjugate(r'흘렀 시작됐 끝났 이어졌 지나갔', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.event],
      subjectThemes: const <WordTheme>[WordTheme.time, WordTheme.weather],
      words: words(r'빛난다 저문다 깊어진다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'빛나니|빛나나|빛나는가 저무니|저무나|저무는가 깊어지니|깊어지나|깊어지는가'),
        PredicateForm.exclamation: words(r'빛나는구나|빛나네|빛나는군 저무는구나|저무네|저무는군 깊어지는구나|깊어지네|깊어지는군'),
        PredicateForm.casual: words(r'빛나 저물어 깊어져'),
        PredicateForm.casualQuestion: words(r'빛나|빛나지 저물어|저물지 깊어져|깊어지지'),
        PredicateForm.polite: words(r'빛나요 저물어요 깊어져요'),
        PredicateForm.politeQuestion: words(r'빛나요|빛나죠 저물어요|저물죠 깊어져요|깊어지죠'),
        PredicateForm.formal: words(r'빛납니다 저뭅니다 깊어집니다'),
        PredicateForm.formalQuestion: words(r'빛납니까 저뭅니까 깊어집니까'),
        PredicateForm.linking: words(r'빛나고 저물고 깊어지고'),
      },
      past: conjugate(r'빛났 저물었 깊어졌', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      ...
      words: words(r'흔들린다 반짝인다 떨어진다 굴러간다 기울어진다 낡아간다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
        ...
        PredicateForm.formalQuestion: words(r'흔들립니까 반짝입니까 떨어집니까 굴러갑니까 기울어집니까 낡아갑니까'),
        PredicateForm.linking: words(r'흔들리고 반짝이고 떨어지고 굴러가고 기울어지고 낡아가고'),
      },
      past: conjugate(r'흔들렸 반짝였 떨어졌 굴러갔 기울어졌 낡아갔', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.thing],
      subjectThemes: const <WordTheme>[WordTheme.music],
      words: words(r'울린다 흐른다 퍼진다 잦아든다 이어진다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'울리니|울리나|울리는가 흐르니|흐르나|흐르는가 퍼지니|퍼지나|퍼지는가 잦아드니|잦아드나|잦아드는가 이어지니|이어지나|이어지는가',
        ),
        PredicateForm.exclamation: words(r'''
          울리는구나|울리네|울리는군 흐르는구나|흐르네|흐르는군 퍼지는구나|퍼지네|퍼지는군 잦아드는구나|잦아드네|잦아드는군 이어지는구나|이어지네|이어지는군
        '''),
        PredicateForm.casual: words(r'울려 흘러 퍼져 잦아들어 이어져'),
        PredicateForm.casualQuestion: words(r'울려|울리지 흘러|흐르지 퍼져|퍼지지 잦아들어|잦아들지 이어져|이어지지'),
        PredicateForm.polite: words(r'울려요 흘러요 퍼져요 잦아들어요 이어져요'),
        PredicateForm.politeQuestion: words(r'울려요|울리죠 흘러요|흐르죠 퍼져요|퍼지죠 잦아들어요|잦아들죠 이어져요|이어지죠'),
        PredicateForm.formal: words(r'울립니다 흐릅니다 퍼집니다 잦아듭니다 이어집니다'),
        PredicateForm.formalQuestion: words(r'울립니까 흐릅니까 퍼집니까 잦아듭니까 이어집니까'),
        PredicateForm.linking: words(r'울리고 흐르고 퍼지고 잦아들고 이어지고'),
      },
      past: conjugate(r'울렸 흘렀 퍼졌 잦아들었 이어졌', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.move,
      subject: const <NounClass>[NounClass.vehicle],
      words: words(r'달린다 멈춘다 지나간다 돌아온다 출발한다 미끄러진다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'달렸 멈췄 지나갔 돌아왔 출발했 미끄러졌', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.idea, NounClass.event],
      words: words(r'번진다 사라진다 남는다 스며든다 되풀이된다 짙어진다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'번졌 사라졌 남았 스며들었 되풀이됐 짙어졌', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.plant],
      words: words(r'자란다 시든다 피어난다 흔들린다 뿌리내린다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'''
      ...
      past: conjugate(r'자랐 시들었 피어났 흔들렸 뿌리내렸', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.body],
      words: words(r'떨린다 움직인다 저린다 굳는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'떨리니|떨리나|떨리는가 움직이니|움직이나|움직이는가 저리니|저리나|저리는가 굳니|굳나|굳는가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'떨렸 움직였 저렸 굳었', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.edible],
      words: words(r'식는다 끓는다 상한다 남는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'식니|식나|식는가 끓니|끓나|끓는가 상하니|상하나|상하는가 남니|남나|남는가'),
        PredicateForm.exclamation: words(r'식는구나|식네|식는군 끓는구나|끓네|끓는군 상하는구나|상하네|상하는군 남는구나|남네|남는군'),
        PredicateForm.casual: words(r'식어 끓어 상해 남아'),
        PredicateForm.casualQuestion: words(r'식어|식지 끓어|끓지 상해|상하지 남아|남지'),
        PredicateForm.polite: words(r'식어요 끓어요 상해요 남아요'),
        PredicateForm.politeQuestion: words(r'식어요|식죠 끓어요|끓죠 상해요|상하죠 남아요|남죠'),
        PredicateForm.formal: words(r'식습니다 끓습니다 상합니다 남습니다'),
        PredicateForm.formalQuestion: words(r'식습니까 끓습니까 상합니까 남습니까'),
        PredicateForm.linking: words(r'식고 끓고 상하고 남고'),
      },
      past: conjugate(r'식었 끓었 상했 남았', statement: '다', endings: _pastEndings),
    ),
    VerbGroup(
      field: VerbField.change,
      subject: const <NounClass>[NounClass.edible],
      subjectThemes: const <WordTheme>[WordTheme.food],
      words: words(r'익는다 녹는다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'익니|익나|익는가 녹니|녹나|녹는가'),
        PredicateForm.exclamation: words(r'익는구나|익네|익는군 녹는구나|녹네|녹는군'),
        PredicateForm.casual: words(r'익어 녹아'),
        PredicateForm.casualQuestion: words(r'익어|익지 녹아|녹지'),
        PredicateForm.polite: words(r'익어요 녹아요'),
        PredicateForm.politeQuestion: words(r'익어요|익죠 녹아요|녹죠'),
        PredicateForm.formal: words(r'익습니다 녹습니다'),
        PredicateForm.formalQuestion: words(r'익습니까 녹습니까'),
        PredicateForm.linking: words(r'익고 녹고'),
      },
      past: conjugate(r'익었 녹았', statement: '다', endings: _pastEndings),
    ),
  ],
  states: <StateGroup>[
    StateGroup(
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.formal: words(
          r'큽니다 작습니다 빠릅니다 느립니다 조용합니다 시끄럽습니다 용감합니다 게으릅니다 부지런합니다 사납습니다 순합니다 영리합니다',
        ),
        PredicateForm.formalQuestion: words(
          r'큽니까 작습니까 빠릅니까 느립니까 조용합니까 시끄럽습니까 용감합니까 게으릅니까 부지런합니까 사납습니까 순합니까 영리합니까',
        ),
      },
      past: conjugate(
        r'컸 작았 빨랐 느렸 조용했 시끄러웠 용감했 게을렀 부지런했 사나웠 순했 영리했',
        statement: '다',
    ...
    StateGroup(
      ...
      past: conjugate(r'배고팠 허기졌', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.full,
      words: words(r'배부르다 든든하다'),
      forms: <PredicateForm, WordPool>{
      ...
      past: conjugate(r'배불렀 든든했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.tired,
      words: words(r'피곤하다 졸리다 나른하다 고단하다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'피곤하니|피곤한가 졸리니|졸린가 나른하니|나른한가 고단하니|고단한가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'피곤했 졸렸 나른했 고단했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.rested,
      words: words(r'상쾌하다 개운하다 활기차다'),
      forms: <PredicateForm, WordPool>{
      ...
      past: conjugate(r'상쾌했 개운했 활기찼', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.content,
      words: words(r'기쁘다 즐겁다 편안하다 만족스럽다 행복하다 뿌듯하다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(
          r'기쁘니|기쁜가 즐겁니|즐거운가 편안하니|편안한가 만족스럽니|만족스러운가 행복하니|행복한가 뿌듯하니|뿌듯한가',
        ),
        PredicateForm.exclamation: words(r'''
      ...
      past: conjugate(r'기뻤 즐거웠 편안했 만족스러웠 행복했 뿌듯했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.restless,
      words: words(r'심심하다 궁금하다 초조하다 답답하다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'심심하니|심심한가 궁금하니|궁금한가 초조하니|초조한가 답답하니|답답한가'),
        PredicateForm.exclamation: words(
      ...
      past: conjugate(r'심심했 궁금했 초조했 답답했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      ...
      past: conjugate(r'아름다웠 낯설었 새로웠 흔했 드물었', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.place],
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.formalQuestion: words(r'넓습니까 좁습니까 고요합니까 깊습니까 어둡습니까 밝습니까 아득합니까 가파릅니까'),
      },
      past: conjugate(r'넓었 좁았 고요했 깊었 어두웠 밝았 아득했 가팔랐', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.event],
      words: words(r'길다 짧다 요란하다 고요하다 갑작스럽다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'기니|긴가 짧니|짧은가 요란하니|요란한가 고요하니|고요한가 갑작스럽니|갑작스러운가'),
        PredicateForm.exclamation: words(
          r'길구나|기네|길군 짧구나|짧네|짧군 요란하구나|요란하네|요란하군 고요하구나|고요하네|고요하군 갑작스럽구나|갑작스럽네|갑작스럽군',
        ),
        PredicateForm.casual: words(r'길어 짧아 요란해 고요해 갑작스러워'),
        PredicateForm.casualQuestion: words(r'길어|길지 짧아|짧지 요란해|요란하지 고요해|고요하지 갑작스러워|갑작스럽지'),
        PredicateForm.polite: words(r'길어요 짧아요 요란해요 고요해요 갑작스러워요'),
        PredicateForm.politeQuestion: words(r'길어요|길죠 짧아요|짧죠 요란해요|요란하죠 고요해요|고요하죠 갑작스러워요|갑작스럽죠'),
        PredicateForm.formal: words(r'깁니다 짧습니다 요란합니다 고요합니다 갑작스럽습니다'),
        PredicateForm.formalQuestion: words(r'깁니까 짧습니까 요란합니까 고요합니까 갑작스럽습니까'),
      },
      past: conjugate(r'길었 짧았 요란했 고요했 갑작스러웠', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.thing, NounClass.vehicle],
      subjectThemes: const <WordTheme>[
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.formalQuestion: words(r'단단합니까 가볍습니까 무겁습니까 매끈합니까 투명합니까 튼튼합니까 반들반들합니까'),
      },
      past: conjugate(r'단단했 가벼웠 무거웠 매끈했 투명했 튼튼했 반들반들했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.thing],
      subjectThemes: const <WordTheme>[WordTheme.music],
      words: words(r'잔잔하다 경쾌하다 구슬프다 감미롭다 흥겹다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'잔잔하니|잔잔한가 경쾌하니|경쾌한가 구슬프니|구슬픈가 감미롭니|감미로운가 흥겹니|흥겨운가'),
        PredicateForm.exclamation: words(r'''
          잔잔하구나|잔잔하네|잔잔하군 경쾌하구나|경쾌하네|경쾌하군 구슬프구나|구슬프네|구슬프군 감미롭구나|감미롭네|감미롭군 흥겹구나|흥겹네|흥겹군
        '''),
        PredicateForm.casual: words(r'잔잔해 경쾌해 구슬퍼 감미로워 흥겨워'),
        PredicateForm.casualQuestion: words(r'잔잔해|잔잔하지 경쾌해|경쾌하지 구슬퍼|구슬프지 감미로워|감미롭지 흥겨워|흥겹지'),
        PredicateForm.polite: words(r'잔잔해요 경쾌해요 구슬퍼요 감미로워요 흥겨워요'),
        PredicateForm.politeQuestion: words(r'잔잔해요|잔잔하죠 경쾌해요|경쾌하죠 구슬퍼요|구슬프죠 감미로워요|감미롭죠 흥겨워요|흥겹죠'),
        PredicateForm.formal: words(r'잔잔합니다 경쾌합니다 구슬픕니다 감미롭습니다 흥겹습니다'),
        PredicateForm.formalQuestion: words(r'잔잔합니까 경쾌합니까 구슬픕니까 감미롭습니까 흥겹습니까'),
      },
      past: conjugate(r'잔잔했 경쾌했 구슬펐 감미로웠 흥겨웠', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.edible],
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.polite: words(r'달아요 셔요 뜨거워요 차가워요'),
        PredicateForm.politeQuestion: words(r'달아요|달죠 셔요|시죠 뜨거워요|뜨겁죠 차가워요|차갑죠'),
        PredicateForm.formal: words(r'답니다 십니다 뜨겁습니다 차갑습니다'),
        PredicateForm.formalQuestion: words(r'답니까 십니까 뜨겁습니까 차갑습니까'),
      },
      past: conjugate(r'달았 셨 뜨거웠 차가웠', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.edible],
      subjectThemes: const <WordTheme>[WordTheme.food],
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.polite: words(r'짜요 매워요 고소해요 담백해요'),
        PredicateForm.politeQuestion: words(r'짜요|짜죠 매워요|맵죠 고소해요|고소하죠 담백해요|담백하죠'),
        PredicateForm.formal: words(r'짭니다 맵습니다 고소합니다 담백합니다'),
        PredicateForm.formalQuestion: words(r'짭니까 맵습니까 고소합니까 담백합니까'),
      },
      past: conjugate(r'짰 매웠 고소했 담백했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.casual: words(r'분명해 흐릿해 영원해 덧없어'),
        PredicateForm.casualQuestion: words(r'분명해|분명하지 흐릿해|흐릿하지 영원해|영원하지 덧없어|덧없지'),
        PredicateForm.polite: words(r'분명해요 흐릿해요 영원해요 덧없어요'),
        PredicateForm.politeQuestion: words(r'분명해요|분명하죠 흐릿해요|흐릿하죠 영원해요|영원하죠 덧없어요|덧없죠'),
        PredicateForm.formal: words(r'분명합니다 흐릿합니다 영원합니다 덧없습니다'),
        PredicateForm.formalQuestion: words(r'분명합니까 흐릿합니까 영원합니까 덧없습니까'),
      },
      past: conjugate(r'분명했 흐릿했 영원했 덧없었', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.idea],
      ...
      forms: <PredicateForm, WordPool>{
        ...
        PredicateForm.polite: words(r'어려워요 쉬워요'),
        PredicateForm.politeQuestion: words(r'어려워요|어렵죠 쉬워요|쉽죠'),
        PredicateForm.formal: words(r'어렵습니다 쉽습니다'),
        PredicateForm.formalQuestion: words(r'어렵습니까 쉽습니까'),
      },
      past: conjugate(r'어려웠 쉬웠', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.idea],
      subjectThemes: const <WordTheme>[WordTheme.color],
      words: words(r'짙다 옅다 선명하다 화사하다 은은하다'),
      forms: <PredicateForm, WordPool>{
        PredicateForm.question: words(r'짙니|짙은가 옅니|옅은가 선명하니|선명한가 화사하니|화사한가 은은하니|은은한가'),
        PredicateForm.exclamation: words(
          r'짙구나|짙네|짙군 옅구나|옅네|옅군 선명하구나|선명하네|선명하군 화사하구나|화사하네|화사하군 은은하구나|은은하네|은은하군',
        ),
        PredicateForm.casual: words(r'짙어 옅어 선명해 화사해 은은해'),
        PredicateForm.casualQuestion: words(r'짙어|짙지 옅어|옅지 선명해|선명하지 화사해|화사하지 은은해|은은하지'),
        PredicateForm.polite: words(r'짙어요 옅어요 선명해요 화사해요 은은해요'),
        PredicateForm.politeQuestion: words(r'짙어요|짙죠 옅어요|옅죠 선명해요|선명하죠 화사해요|화사하죠 은은해요|은은하죠'),
        PredicateForm.formal: words(r'짙습니다 옅습니다 선명합니다 화사합니다 은은합니다'),
        PredicateForm.formalQuestion: words(r'짙습니까 옅습니까 선명합니까 화사합니까 은은합니까'),
      },
      past: conjugate(r'짙었 옅었 선명했 화사했 은은했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.plant],
      ...
      past: conjugate(r'푸르렀 무성했 향기로웠 시들했', statement: '다', endings: _pastEndings),
    ),
    StateGroup(
      subject: const <NounClass>[NounClass.body],
      ...
      past: conjugate(r'따뜻했 차가웠 아팠 뻣뻣했', statement: '다', endings: _pastEndings),
    ),
  ],
  modifiers: <ModifierGroup>[
    ...
    ModifierGroup(
      subject: const <NounClass>[NounClass.person],
      words: words(r'젊은 친절한 엄격한 진지한 바쁜 성실한 낯선 유쾌한'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.creature],
      words: words(r'날쌘 사나운 순한 겁많은 통통한 조그만'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.edible],
    ...
    ModifierGroup(
      ...
      words: words(r'달콤한 따뜻한 차가운 시원한 뜨거운 향긋한 신선한 새콤한 진한 씁쓸한 시원한'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.thing, NounClass.vehicle],
      words: words(r'낡은 새로운 작은 커다란 가벼운 무거운 반짝이는 매끈한 투명한 단단한 예쁜 소중한 오래된 반듯한'),
    ),
    ModifierGroup(subject: const <NounClass>[NounClass.vehicle], words: words(r'빠른 느린 덜컹거리는 튼튼한')),
    ModifierGroup(
      subject: const <NounClass>[NounClass.place],
      words: words(r'고요한 넓은 어두운 밝은 낯선 오래된 아늑한 한적한 북적이는 조용한 외딴 먼 가까운 텅빈 쓸쓸한 환한'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.plant],
      words: words(r'푸른 무성한 향기로운 어린 시든 커다란 작은 여린 싱싱한'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.idea],
      words: words(r'희미한 오래된 새로운 낯선 분명한 소중한 작은 엉뚱한 막연한'),
    ),
    ModifierGroup(
      subject: const <NounClass>[NounClass.event],
  ...
  manners: <ModifierGroup>[
    ModifierGroup(
      ...
      words: words(r'''
        ...
        은근히 대뜸 나직이 느릿느릿 재빨리 가볍게 얌전히 무심히 덤덤히 성실히 신나게 살짝 부리나케 천연덕스럽게
      '''),
    ),
    ModifierGroup(
      subject: const <NounClass>[
      ...
      words: words(r'조용히 천천히 서서히 문득 다시 계속 잠시 갑자기 언제나 여전히 은은히 살며시 가만히 슬며시 조금씩 차츰 점점 어느새 고요히'),
    ),
  ],
  times: SentenceTimes(
  ...
  connectives: <ConnectiveKind, WordPool>{
    ConnectiveKind.additive: words(r'그리고 게다가 그러고는'),
