...
final SentenceLanguageData zh = SentenceLanguageData(
  ...
  verbs: <VerbGroup>[
    ...
    VerbGroup(
      ...
      words: words(r'微笑 哼歌 大笑 咯咯笑 傻笑 欢呼 点头 拍手 眨眼 咧嘴笑 眉开眼笑 笑出声 轻笑 哼着小曲'),
    ),
    VerbGroup(
      field: VerbField.express,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.restless,
      words: words(r'哭泣 叹气 咕哝 抽泣 呜咽 抱怨 嘀咕 皱眉 摇头 自言自语 流泪 踱步 咬嘴唇 挠头 撇嘴 坐立不安 唉声叹气 发牢骚'),
    ),
    VerbGroup(
      field: VerbField.express,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.tired,
      words: words(r'打哈欠 揉眼睛 伸懒腰 揉肩膀 转脖子 捶背'),
    ),
    VerbGroup(
      field: VerbField.express,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      condition: Condition.hungry,
      words: words(r'咽口水 舔嘴唇 摸肚子 吸鼻子 流口水'),
    ),
    VerbGroup(
      field: VerbField.express,
      subject: const <NounClass>[NounClass.creature, NounClass.person],
      words: words(r'喊叫 倒吸一口气 耸肩 挥手 脸红 尖叫 叫喊 歪头 瞪大眼睛 回头 抬头 一愣'),
    ),
    VerbGroup(
  ...
  traits: <NounTrait, WordPool>{
    NounTrait.flier: words(r'''
      ...
      蜉蝣 苍蝇 蚊子 神龙 火龙 冰龙 黑龙 白龙 青龙 凤凰 妖精 精灵 仙女 天使 天马 神鸟 朱雀 三足乌 蛟龙 鸟女 石像鬼 小恶魔 小妖精 女武神 鸽子 海鸥 鸳鸯 鲲鹏
    '''),
    NounTrait.swimmer: words(r'''
      鲸鱼 海豚 鲨鱼 乌龟 海豹 企鹅 青蛙 章鱼 乌贼 海星 螃蟹 龙虾 鲤鱼 三文鱼 鳄鱼 蝌蚪 蟾蜍 雨蛙 鲫鱼 鲶鱼 黑鱼 鳜鱼 青鳉 泥鳅 鳗鱼 海鳗 带鱼 鲅鱼 秋刀鱼 凤尾鱼
      黄鱼 明太鱼 人鱼 美人鱼 海妖 巨乌贼 海兽王 海龟 金鱼 水母
    '''),
    NounTrait.crawler: words(r'''
      乌龟 蜥蜴 变色龙 蟒蛇 蜗牛 蚂蚁 蜘蛛 螃蟹 鳄鱼 螳螂 蚯蚓 蜈蚣 马陆 蝎子 壁虱 跳蚤 蚕蛹 毛虫 蝾螈 菜花蛇 蝮蛇 毒蛇 眼镜蛇 响尾蛇 鬣蜥 蛇王 海龟 蟑螂 蛇精
    '''),
    NounTrait.lifeless: words(r'''
      魔法 魔力 咒语 诅咒 预言 神谕 结界 护符 封印 幻影 陶俑 女神像 御守 咒文字 符咒 阵法 巫术 祈福 前兆 预兆 预言书 神话集 传说集 奇谭集 仙丹 法宝 魔杖 水晶球 魔镜
      飞毯 圣杯 符文 魔药 鬼火 龙宫 天宫
    '''),
    NounTrait.placeless: words(r'''
      朝阳 波浪 潮水 沙粒 卵石 地震 余烬 珊瑚 回声 影子 冰碛 岩屑 岩盘 间歇泉 喷气孔 钟乳石 石笋 地平 水平 星辰 太阳 彗星 流星 极光 新月 星尘 日食 月食 天顶 月明
      星明 卫星 星团 星座 轨道 引力 自转 公转 黑子 太阳风 光年 天体 恒星 天球 黄道 超新星 流星雨 宇宙尘 失重 满月 朔月 半月 上弦 下弦 月光 星光 北极星 日冕 月晕 星轨
      浪花 泡沫 漩涡 激流 雪崩 泥石流 洪水 海啸 岩浆 涟漪 泥土 尘土 火焰 火花 篝火 烟雾 化石 海平线 日出 日落 星星 星图 北斗星 牛郎星 织女星 天狼星 启明星 仙女座
      猎户座 残月 月相 月壤 耀斑 反物质 暗物质 暗能量 白矮星 红巨星 中子星 脉冲星 双星 光速 大爆炸 时空 土星环 凌日
    '''),
  },
