...
/// [randCountry], reporting the language each country was written in.
///
...
///
/// ```dart
/// randCountryDetails(language: LocationLanguage.en).first;
/// // LocationDetail(United States, en, country, United States, null, null, null)
/// ```
List<LocationDetail> randCountryDetails({
