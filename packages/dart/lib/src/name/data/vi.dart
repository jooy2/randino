...
/// The Vietnamese name dataset.
final NameLanguageData vi = NameLanguageData(
  ...
  '''),
  middleMale: pool(r'Văn Hữu Đức Minh Quang Thành Xuân Bá Công Trọng Quốc Nhật Chí Đình Thế'),
  middleFemale: pool(r'Thị Ngọc Thanh Thu Kim Hồng Mỹ Diễm Bích Phương Thùy Cẩm Ánh Nhã Hoài'),
  syn: vietnameseSyllables,
);
