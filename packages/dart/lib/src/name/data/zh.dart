...
/// The Chinese name dataset.
final NameLanguageData zh = NameLanguageData(
  ...
  givenFemale: tokenPool(r'''
    ...
    艳:Yan 梅:Mei 兰:Lan 红:Hong 萍:Ping 慧:Hui 洁:Jie 颖:Ying 婷:Ting
  '''),
  firstMale: tokenPool(r'''
  ...
  restFemale: tokenPool(r'''
    ...
    琳:lin 悦:yue 华:hua 芳:fang 敏:min 梦:meng 瑶:yao
  '''),
);
