...
export const ZH: WordLanguageData = {
	...
	nouns: {
		...
		object: words(`
			...
			羽毛笔 笔尖 吸墨纸 文件夹 活页夹 写字板 便条本 书签绳 纸夹 图钉 铆钉 螺栓 螺丝 垫圈 支架 合页 门闩 挂锁 钥匙环 铁链 绳索 细绳 流苏 带扣 拉链 按扣 粘扣
		...
		plant: words(`
			...
			李树 接骨木 山茱萸 木兰花 山茶花 杜鹃花 映山红 绣球花 紫藤 忍冬 栀子 夹竹桃 三角梅 木槿 金盏花 百日菊 矮牵牛 秋海棠 天竺葵 报春花 雪滴花 风铃草 毛地黄
		...
		myth: words(`
			...
			女神 魔法 魔力 咒语 诅咒 预言 神谕 结界 护符 封印 幻影 独角兽 半人马 美人鱼 狼人 吸血鬼 僵尸 木乃伊 石像鬼 巨魔 兽人 地精 矮人 小妖 天马 神鸟 白虎 朱雀
			玄武 三足乌 山神 海神 雷神 风神 龙神 灵魂 魂魄 蛟龙 蛇王 人面狮 合成兽 地狱犬 半神 泰坦 精灵女 树精 水精 海妖 鸟女 蛇发女 牛头人 山羊人 牧神 狮身像
			巨乌贼 海兽王 陆兽王 报丧女 亡灵 死灵 尸鬼 影法师 幽体 骚灵 魔神 炎魔 陶俑 人造人 小恶魔 山魈 小妖精 家妖精 土精 食人魔 巨人族 战女神 女武神 修罗 女神像
			诗神 神谕者 贤者 黑法师 魔术士 咒术士 降灵士 炼金士 御守 咒文字 符咒 阵法 结界术 巫术 祈福 前兆 预兆 预言书 神话集 传说集 奇谭集
		`),
		job: words(`
		...
		music: words(`
			...
			谱号 五线谱 记谱法 总谱 乐谱集 节拍器 调音器 放大器 踏板 簧片 琴弓 琴弦 指板 音孔 吹嘴 活塞 鼓槌 小鼓 低音部 强拍 弱拍 切分音 即兴曲 音乐会 巡演 返场
			喝彩 独奏会 发表会
		`),
		place: words(`
			...
			作坊 工作室 画廊 档案馆 观测站 天文馆 温室馆 玻璃房 葡萄园 农庄 晒场 粮仓 风车房 水车房 瞭望塔 钟楼 尖塔 回廊 礼拜堂 圣所 修道院 神学院 棱堡 望楼 吊桥
		...
		vehicle: words(`
			...
			驳船 渔船 双翼机 水上机 探测器 登陆器 雪地车 独轮车 摩托 拖车 灵车 婴儿车 小汽车 货车 清扫车 洒水车 巡逻艇 拖船 潜水艇 小艇 卧铺 客车 快车 慢车 货船 游船
		...
		product: words(`
			...
			吹风机 乳液 防晒霜 床垫 窗帘 门铃 温度计 灭火器 手电筒 计算器 灯泡 插座 排插 被子 枕套 毛巾 脸盆 洗衣液 柔顺剂 空气扇 压力锅 炒锅 电饭锅 咖啡机 打蛋器
			削皮刀 开瓶器 保温壶 水杯 门垫 衣架 衣柜 书架 床头柜 躺椅 沙发垫 脚凳 床架 被套 枕巾 花洒 水龙头 通厕器 刮水器 晾衣杆 衣夹 熨衣板 量杯 量勺 擀面杖 搅拌器
			滤网 隔热垫
		`),
		color: words(`
		...
		space: words(`
			...
			光年 天体 恒星 天球 黄道 银河系 黑洞 超新星 流星雨 宇宙尘 太阳系 银河核 平流层 大气层 真空 失重 满月 朔月 半月 上弦 下弦 月光 星光 北极星 木星 火星 金星
