...
const NOUNS = taggedNouns({
	...
	sport: `
		...
		Ringe:p Bock:m Schachspiel:n Domino:n Stürmer:m Verteidiger:m Trainer:m Stadion:n
	...
	product: `
		...
		Wasserkocher:m Heizkörper:m Thermostat:n Teppich:m Jalousie:f Leuchter:m Besteck:n
