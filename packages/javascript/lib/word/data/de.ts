...
const NOUNS = taggedNouns({
	...
	gem: `
		...
		Graphit:n Quecksilber:n Gips:m Ader:f Olivin:m Turmalin:m Rubin:m Saphir:m Smaragd:m
	...
	myth: `
		...
		Riese:m Chimäre:f Hydra:f Greif:m Zentaur:m Minotaurus:m Sphinx:f Pegasus:m Krake_Sage:m
	...
	food: `
		...
		Frikadelle:f Schnitzel:n Braten:m Marmelade:f Honig:m Sahne:f Quark:m Klöße:m Knödel:m
	`,
	sport: `
	...
	finance: `
		...
		Übernahme:f Rettung:f Sicherheit:f Gutschein:m Barren_Gold:m Tresor:m Staatskasse:f
	...
	tech: `
		...
		Firmware:f Bandbreite:f Latenz:f Torweg:m Brandmauer:f Teilnetz:n Rechnername:m Nutzlast:f
		Prüfsumme:f Schema:n Sicherung:f Verbund:m Splitter:m Abbild:n Behälter:m Sandkasten:m
		Fließband:n Ablage:f Fehlersucher:m Makro:n Feld:n Matrix:f Ganzzahl:f Syntax:f
		Zerteiler:m Assembler:m Befehl:m Bitrate:f Durchsatz:m Handschlag:m Namensraum:m
		Vermittler:m Endpunkt:m Streuwert:m Darstellung:f Schattierer:m Textur:f Vieleck:n
		Gitternetz:n Oktett:n Wegewahl:f Vermittlung:f Rundruf:m Datagramm:n Startlader:m
		Dateisystem:n Partition:f Verzeichnis:n Prüfpunkt:m Rückrollung:f Umzug:m
	`,
	weather: `
	...
	space: `
		...
		Milchstraße:f Finsternis:f Weltall:n Planet:m Trabant:m Kleinplanet:m Nebel_Stern:m
	...
	body: `
		...
		Bluterguss:m Blase_Haut:f Schwiele:f
	`,
	clothing: `
		...
		Mütze:f Kappe:f Helm_Kleid:m Turban:m Schleier:m Tuch:n
	`,
	tool: `
...
export const DE: WordLanguageData = {
	...
	capitalize: false,
	adjectives: words(`
		blau grün rot schwarz weiß gelb golden silbern dunkel_hell hell glänzend groß klein lang
		kurz breit schmal hoch_gross niedrig schnell langsam stark schwach hart weich warm kalt
		...
		schelmisch edel bescheiden freundlich wild_wild flink stachelig ruhelos kräftig verworren
	...
	actions: words(`
		...
		flüsternd leuchtend blinkend schwebend wiegend kreisend schleichend hüpfend springend
