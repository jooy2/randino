...
const NOUNS = taggedNouns({
	...
	sport: `
		...
		ракетка:f бита:f ворота:n медаль:f кубок:m чемпион:m финал:m отбор:m тренировка:f
	...
	time: `
		...
		рань:f канун:m вчера:n сегодня:n сутки:f неделя:f месяц:m квартал:m полугодие:n год:m
