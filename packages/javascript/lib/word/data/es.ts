...
const NOUNS = taggedNouns({
	...
	product: `
		...
		freidora:f exprimidor:m hervidor:m calefactor:m radiador:m termostato:m alfombra:f estor:m
		persiana:f aplique:m flexo:m cubertería:f vajilla:f cristalería:f mantel:m servilleta:f
