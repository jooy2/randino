...
const NOUNS = taggedNouns({
	...
	place: `
		...
		fienile:m baita:f belvedere:m gioco:m palestra:f piscina:f acquario:m galleria:f zoo:m
	...
	food: `
		...
		bistecca:f costoletta:f marmellata:f miele:m tiramisu:m cannolo:m
	`,
	sport: `
	...
	space: `
		...
		polare:f vespro:m marte:m venere:f giove:m saturno:m urano:m nettuno:m plutone:m
