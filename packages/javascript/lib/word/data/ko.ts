...
export const KO: WordLanguageData = {
	...
	nouns: {
		animal: words(`
			...
			임팔라 얼룩말 라마 알파카 낙타 당나귀 노새 조랑말 망아지 송아지 새끼양 오리새끼 매미 귀뚜라미 사마귀 하루살이 풍뎅이 사슴벌레 반딧불 지렁이 지네 노래기 전갈
		...
		object: words(`
			...
			잉크병 깃펜 펜촉 압지 봉투 서류철 바인더 클립보드 메모지 책갈피끈 종이집게 압정 못머리 리벳 볼트 나사 와셔 받침쇠 경첩 걸쇠 자물통 열쇠고리 쇠사슬 밧줄끈
			노끈 끈목 리본끈 술장식 버클 지퍼 똑딱이 찍찍이 헝겊조각 문장 배지 팔찌 장신구 브로치 커프스 머리핀 머리띠 손목띠 발찌 가방끈 주머니 손가방 여행가방 궤짝
		...
		plant: words(`
			...
			메밀꽃 포플러 사시나무 오리나무 개암 마가목 산사나무 자두나무 딱총나무 층층나무 목련꽃 동백꽃 진달래꽃 철쭉꽃 수국꽃 등나무 인동초 재스민 치자 협죽도 무궁화
			금잔화 백일홍 페튜니아 베고니아 제라늄 앵초 설강화 블루벨 델피늄 참제비 루피너스 과꽃 국화꽃 달리아 프리지어 아네모네 미나리 민들레꽃 엉겅퀴 쐐기풀 산딸기
			히스 가시금작 고사리류 속새 우산이끼 지의류 해초 다시마 조류 왕대 등나무줄 야자수 유카 용설란 선인장 다육 알로에 바질 타임 로즈메리 오레가노 파슬리 고수
		...
		concept: words(`
			...
			침묵 속삭임 직관 이성 판단 교리 정리 공리 따름정리 가설 역설 딜레마 패러다임 틀거리 전제 추론 연역 귀납 유추 은유 상징 모티프 서사 연대기 기록물 문서고
		...
		myth: words(`
			...
			마왕 용왕 여신 수호신 성배 마검 부적 룬 봉인 환영 마술 도술 술법 마법진 명계 이무기용 만티코어 키마이라 키클롭스 티탄 님프 드리아드 나이아드 세이렌 고르곤
			미노타우 켄타우로 사티로스 파우누스 스핑크스 페가수스 크라켄 베헤모스 밴시 망령 사령 구울 그림자령 유령체 폴터가이 진니 이프리트 골렘체 호문쿨루 가고일 임프
			스프라이 픽시 코볼트 노움 오거 거인족 발키리 노른 복수신 운명신 뮤즈 신탁자 현자 흑마법사 소서러 주술사 강령술사 부적물 호부 룬문자 인장술 문양술 저주술
		...
		music: words(`
			...
			비브라토 트레몰로 글리산도 옥타브 반음 선법 조성 음자리표 오선 기보 총보 악보집 메트로놈 조율기 증폭기 페달 리드 보면대 현 지판 울림통 밸브 북채 스네어
		...
		place: words(`
			...
			수족관 미술관 성당 요새 농장 목장 과수원 마천루 전시장 대로 해안 아케이드 골목길 안마당 테라스 발코니 베란다 중정 현관 로비 통로 계단참 누각 지하층 저장고
			다락방 지붕 곳간 골방 작업장 작업실 화랑 기록관 관측소 천문대 전시관 유리온실 포도밭 초지 목초지 농가 앞뜰 곳집 풍차 물레방아 봉화대 망루 종탑 첨탑 회랑
			예배당 사당 성소 수도원 대성당 성채 성벽 보루 망대 도개교 해자 문루 아성 시장터 장터 상점가 헛간 물류창고 터미널 방죽 선착장 잔교 방파제 정박지 나루 해변
			야영지 산장 별장 저택 장원 촌락
		`),
		food: words(`
		...
		sport: words(`
			...
			버디 보기 퍼터 경마장 관중석 응원석 심판석 선수단 감독석 벤치 후보석 결승점 반환점
		`),
		vehicle: words(`
		...
		product: words(`
			...
			압력솥 프라이팬 냄비뚜껑 채반 거품기 감자칼 보온병 텀블러 발매트 옷걸이 옷장 책장 협탁 안락의자 소파쿠션 발받침 침대틀 침대보 베개커버 샤워기 수도꼭지 뚫어뻥
		...
		space: words(`
			...
			목성 토성 천왕성 해왕성 수성 명왕성 궤도 중력 자전 공전 흑점 태양풍 분화구 월면 광년 천체 성간 항성 성좌 천구 황도 은하계 블랙홀 초신성 유성우 우주먼지
		...
		time: words(`
			...
			입하 입추 입동 소서 대서 소한 대한 경칩 청명 곡우 망종 백로 상강 시각 시간 영겁 유년 청춘 노년 말년 여생 시절 무렵 옛날 지금 나중 새벽녘 저물녘 해뜰녘
			한창 한때 잠깐 잠시 백년 천년
		`),
		emotion: words(`
		...
		`),
		body: words(`
			머리 이마 눈썹 속눈썹 눈꺼풀 코 콧등 입 입술 잇몸 혀 턱 볼 뺨 귀 귓바퀴 목 목덜미 어깨 팔 팔꿈치 손목 손 손바닥 손등 손가락 손톱 주먹 가슴 갈비 배꼽
		...
		tool: words(`
			...
			크랭크 렌치자루 죔쇠 물미 정 끌망치 다듬돌 숫돌 줄칼 강판 체 삽자루 곡괭이날 쟁기날 써레 도리깨 키질 방추 잉아 바디 얼레 자새 활비비 손잡이 톱날 도끼날
		...
		drink: words(`
			...
			국화차 생강차 모과차 칡즙 식초 탄산 음료 음료수 청량음료 과실주 곡주 증류주 발효주 흑맥주 생맥주 감주 단술 숭늉 차 찻물 냉수 온수 얼음물 설탕물 꿀물
			우유차 밀크티 홍차라떼 홍차 캔커피 병맥주 캔맥주 우롱 곡차 보리음료
		`)
	},
