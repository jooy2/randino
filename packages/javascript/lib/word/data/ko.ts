...
export const KO: WordLanguageData = {
	...
	nouns: {
		...
		plant: words(`
			...
			금잔화 백일홍 페튜니아 베고니아 제라늄 앵초 설강화 블루벨 델피늄 초롱꽃 루피너스 과꽃 국화꽃 달리아 프리지어 아네모네 미나리 민들레꽃 엉겅퀴 쐐기풀 산딸기
			히스 수레국화 고사리류 속새 우산이끼 지의류 해초 다시마 조류 왕대 등나무줄 야자수 유카 용설란 선인장 다육 알로에 바질 타임 로즈메리 오레가노 파슬리 고수
		...
		myth: words(`
			...
			삼신 픽시 코볼트 노움 오거 거인족 발키리 노른 복수신 운명신 뮤즈 신탁자 현자 흑마법사 소서러 주술사 강령술사 호신부 호부 룬문자 인장술 문양술 저주술
