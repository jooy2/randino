	...
	verbs: [
		...
		},
		{
			...
			forms: {
				...
				formal: words(`먹습니다 마십니다 씹습니다 삼킵니다 맛봅니다 굽습니다 데웁니다`),
				formalQuestion: words(`먹습니까 마십니까 씹습니까 삼킵니까 맛봅니까 굽습니까 데웁니까`)
			}
		},
		{
			subject: ['creature', 'person'],
		...
		},
		{
			...
			forms: {
				...
				casual: words(`만들어|만들지 고쳐|고치지 닦아|닦지 팔아|팔지 사|사지 손질해|손질하지`),
				polite: words(
					`만들어요|만들죠 고쳐요|고치죠 닦아요|닦죠 팔아요|팔죠 사요|사죠 손질해요|손질하죠`
				),
				formal: words(`만듭니다 고칩니다 닦습니다 팝니다 삽니다 손질합니다`),
				formalQuestion: words(`만듭니까 고칩니까 닦습니까 팝니까 삽니까 손질합니까`)
			}
		},
		{
			...
			forms: {
				...
				casual: words(`꿈꿔|꿈꾸지 기억해|기억하지 잊어|잊지 상상해|상상하지 헤아려|헤아리지`),
				polite: words(
					`꿈꿔요|꿈꾸죠 기억해요|기억하죠 잊어요|잊죠 상상해요|상상하죠 헤아려요|헤아리죠`
				),
				formal: words(`꿈꿉니다 기억합니다 잊습니다 상상합니다 헤아립니다`),
				formalQuestion: words(`꿈꿉니까 기억합니까 잊습니까 상상합니까 헤아립니까`)
			}
		},
		{
			subject: ['place', 'event'],
			...
			forms: {
				...
				formal: words(`빛납니다 흐릅니다 저뭅니다 밝아옵니다 깊어집니다 조용해집니다 물듭니다`),
				formalQuestion: words(
		...
		},
		{
			...
			forms: {
				...
				formalQuestion: words(`흔들립니까 반짝입니까 떨어집니까 굴러갑니까 기울어집니까 낡아갑니까`)
			}
		},
		{
			subject: ['vehicle'],
