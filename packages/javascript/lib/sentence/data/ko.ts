...
export const KO: SentenceLanguageData = {
	...
	// Each group also writes the same verbs in every other form Korean has —
	...
	// the first clause of a two-clause sentence takes. The past is written as
	// stems and the endings above.
	verbs: [
		{
			field: 'rise',
			...
			forms: {
				...
				casual: words(`일어나|일어나지 일어서|일어서지 깨어나|깨어나지 눈떠|눈뜨지`),
				polite: words(`일어나요|일어나죠 일어서요|일어서죠 깨어나요|깨어나죠 눈떠요|눈뜨죠`),
				formal: words(`일어납니다 일어섭니다 깨어납니다 눈뜹니다`),
				formalQuestion: words(`일어납니까 일어섭니까 깨어납니까 눈뜹니까`),
				linking: words(`일어나서|일어나고 일어서서|일어서고 깨어나서|깨어나고 눈떠서|눈뜨고`)
			},
			past: conjugate(`일어났 일어섰 깨어났 눈떴`, PAST)
		},
		...
		// their own. `향한다` wants a `시장으로` in front of it; `떠난다` does not.
		{
			...
			words: words(`간다 향한다 달려간다 올라간다 내려간다`),
			forms: {
				question: words(
					`가니|가나|가는가 향하니|향하나|향하는가 달려가니|달려가나|달려가는가 올라가니|올라가나|올라가는가 내려가니|내려가나|내려가는가`
				),
				exclamation: words(`
					가는구나|가네|가는군 향하는구나|향하네|향하는군 달려가는구나|달려가네|달려가는군 올라가는구나|올라가네|올라가는군 내려가는구나|내려가네|내려가는군
				`),
				casual: words(`가|가지 향해|향하지 달려가|달려가지 올라가|올라가지 내려가|내려가지`),
				polite: words(
					`가요|가죠 향해요|향하죠 달려가요|달려가죠 올라가요|올라가죠 내려가요|내려가죠`
				),
				formal: words(`갑니다 향합니다 달려갑니다 올라갑니다 내려갑니다`),
				formalQuestion: words(`갑니까 향합니까 달려갑니까 올라갑니까 내려갑니까`),
				linking: words(
					`가서|가고 향해서|향하고 달려가서|달려가고 올라가서|올라가고 내려가서|내려가고`
				)
			},
			past: conjugate(`갔 향했 달려갔 올라갔 내려갔`, PAST)
		},
		{
			field: 'go',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`떠나|떠나지 나서|나서지 출발해|출발하지 길을떠나|길을떠나지`),
				polite: words(`떠나요|떠나죠 나서요|나서죠 출발해요|출발하죠 길을떠나요|길을떠나죠`),
				formal: words(`떠납니다 나섭니다 출발합니다 길을떠납니다`),
				formalQuestion: words(`떠납니까 나섭니까 출발합니까 길을떠납니까`),
				linking: words(`떠나서|떠나고 나서서|나서고 출발해서|출발하고 길을떠나서|길을떠나고`)
			},
			past: conjugate(`떠났 나섰 출발했 길을떠났`, PAST)
		},
		{
			field: 'arrive',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				`),
				casual: words(`들어와|들어오지 닿아|닿지 이르러|이르지 다다라|다다르지 들어서|들어서지`),
				polite: words(
			...
			past: conjugate(`들어왔 닿았 이르렀 다다랐 들어섰`, PAST)
		},
		{
			field: 'arrive',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`돌아와|돌아오지 도착해|도착하지 돌아가|돌아가지 귀가해|귀가하지`),
				polite: words(`돌아와요|돌아오죠 도착해요|도착하죠 돌아가요|돌아가죠 귀가해요|귀가하죠`),
				formal: words(`돌아옵니다 도착합니다 돌아갑니다 귀가합니다`),
				formalQuestion: words(`돌아옵니까 도착합니까 돌아갑니까 귀가합니까`),
				linking: words(`돌아와서|돌아오고 도착해서|도착하고 돌아가서|돌아가고 귀가해서|귀가하고`)
			},
			past: conjugate(`돌아왔 도착했 돌아갔 귀가했`, PAST)
		},
		{
			field: 'move',
			subject: ['creature', 'person'],
			words: words(`
				달린다 걷는다 뛴다 헤엄친다 날아오른다 기어간다 서성인다 지나간다 어슬렁댄다 뛰어다닌다 거닌다 산책한다
			`),
			forms: {
				question: words(`
				...
				`),
				formal: words(`
					달립니다 걷습니다 뜁니다 헤엄칩니다 날아오릅니다 기어갑니다 서성입니다 지나갑니다 어슬렁댑니다 뛰어다닙니다 거닙니다 산책합니다
				`),
				formalQuestion: words(`
					달립니까 걷습니까 뜁니까 헤엄칩니까 날아오릅니까 기어갑니까 서성입니까 지나갑니까 어슬렁댑니까 뛰어다닙니까 거닙니까 산책합니까
				`),
				linking: words(`
					달리고 걷고 뛰고 헤엄치고 날아오르고 기어가고 서성이고 지나가고 어슬렁대고 뛰어다니고 거닐고 산책하고
				`)
			},
			past: conjugate(
				`달렸 걸었 뛰었 헤엄쳤 날아올랐 기어갔 서성였 지나갔 어슬렁댔 뛰어다녔 거닐었 산책했`,
				PAST
			)
		},
		{
			field: 'wait',
			subject: ['creature', 'person'],
			words: words(`기다린다 두리번거린다 숨는다 뒤척인다 머뭇거린다 기웃거린다 멈춘다 멈춰선다`),
			forms: {
				question: words(`
				...
				linking: words(`기다리고 두리번거리고 숨고 뒤척이고 머뭇거리고 기웃거리고 멈추고 멈춰서고`)
			},
			past: conjugate(`기다렸 두리번거렸 숨었 뒤척였 머뭇거렸 기웃거렸 멈췄 멈춰섰`, PAST)
		},
		{
			field: 'rest',
			subject: ['creature', 'person'],
			words: words(`쉰다 앉는다 눕는다 기댄다 웅크린다 드러눕는다`),
			forms: {
				question: words(
				...
				`),
				casual: words(
					`쉬어|쉬지 앉아|앉지 누워|눕지 기대|기대지 웅크려|웅크리지 드러누워|드러눕지`
				),
				polite: words(
					`쉬어요|쉬죠 앉아요|앉죠 누워요|눕죠 기대요|기대죠 웅크려요|웅크리죠 드러누워요|드러눕죠`
				),
				formal: words(`쉽니다 앉습니다 눕습니다 기댑니다 웅크립니다 드러눕습니다`),
				formalQuestion: words(`쉽니까 앉습니까 눕습니까 기댑니까 웅크립니까 드러눕습니까`),
				linking: words(`쉬고 앉아서|앉고 누워서|눕고 기대고 웅크리고 드러누워서|드러눕고`)
			},
			past: conjugate(`쉬었 앉았 누웠 기댔 웅크렸 드러누웠`, PAST)
		},
		{
			field: 'sleep',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`잠자|잠자지 잠들어|잠들지 졸아|졸지 꾸벅여|꾸벅이지`),
				polite: words(`잠자요|잠자죠 잠들어요|잠들죠 졸아요|졸죠 꾸벅여요|꾸벅이죠`),
				formal: words(`잠잡니다 잠듭니다 좁니다 꾸벅입니다`),
				formalQuestion: words(`잠잡니까 잠듭니까 좁니까 꾸벅입니까`),
				linking: words(`잠자고 잠들고 졸고 꾸벅이고`)
			},
			past: conjugate(`잠잤 잠들었 졸았 꾸벅였`, PAST)
		},
		{
			field: 'express',
			subject: ['creature', 'person'],
			words: words(`웃는다 운다 하품한다 한숨짓는다 미소짓는다 콧노래한다 중얼거린다 소리친다`),
			forms: {
				question: words(`
				...
				linking: words(`웃고 울고 하품하고 한숨짓고 미소짓고 콧노래하고 중얼거리고 소리치고`)
			},
		...
		},
		{
			...
			forms: {
				...
				linking: words(`춤추고 노래하고 뒹굴고 뛰놀고 장난치고 뛰어오르고 폴짝거리고 구르고`)
			},
			past: conjugate(`춤췄 노래했 뒹굴었 뛰놀았 장난쳤 뛰어올랐 폴짝거렸 굴렀`, PAST)
		},
		{
			field: 'think',
			...
			forms: {
				...
				linking: words(`꿈꾸고 기억하고 잊고 상상하고 헤아리고 떠올리고 그리워하고 궁금해하고`)
			},
			past: conjugate(`꿈꿨 기억했 잊었 상상했 헤아렸 떠올렸 그리워했 궁금해했`, PAST)
		},
		{
			field: 'look',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				linking: words(`보고 바라보고 살피고 들여다보고 구경하고 만지고 쓰다듬고 지켜보고`)
			},
			past: conjugate(`봤 바라봤 살폈 들여다봤 구경했 만졌 쓰다듬었 지켜봤`, PAST)
		},
		{
			field: 'search',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`찾아다녀|찾아다니지 헤매|헤매지 둘러봐|둘러보지 살펴봐|살펴보지`),
				polite: words(`찾아다녀요|찾아다니죠 헤매요|헤매죠 둘러봐요|둘러보죠 살펴봐요|살펴보죠`),
				formal: words(`찾아다닙니다 헤맵니다 둘러봅니다 살펴봅니다`),
				formalQuestion: words(`찾아다닙니까 헤맵니까 둘러봅니까 살펴봅니까`),
				linking: words(`찾아다니고 헤매고 둘러보고 살펴보고`)
			},
			past: conjugate(`찾아다녔 헤맸 둘러봤 살펴봤`, PAST)
		},
		{
			field: 'find',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`찾아|찾지 발견해|발견하지 주워|줍지 찾아내|찾아내지`),
				polite: words(`찾아요|찾죠 발견해요|발견하죠 주워요|줍죠 찾아내요|찾아내죠`),
				formal: words(`찾습니다 발견합니다 줍습니다 찾아냅니다`),
				formalQuestion: words(`찾습니까 발견합니까 줍습니까 찾아냅니까`),
				linking: words(`찾아서|찾고 발견하고 주워서|줍고 찾아내서|찾아내고`)
			},
			past: conjugate(`찾았 발견했 주웠 찾아냈`, PAST)
		},
		{
			field: 'take',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				formalQuestion: words(`챙깁니까 고릅니까 집습니까 얻습니까 받습니까 꺼냅니까 움켜쥡니까`),
				linking: words(
					`챙겨서|챙기고 골라서|고르고 집어서|집고 얻어서|얻고 받아서|받고 꺼내서|꺼내고 움켜쥐고`
				)
			},
			past: conjugate(`챙겼 골랐 집었 얻었 받았 꺼냈 움켜쥐었`, PAST)
		},
		{
			field: 'carry',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				`),
				casual: words(`옮겨|옮기지 날라|나르지 가져와|가져오지 들고와|들고오지 안고와|안고오지`),
				polite: words(
				...
				linking: words(`옮기고 나르고 가져와서|가져오고 들고와서|들고오고 안고와서|안고오고`)
			},
			past: conjugate(`옮겼 날랐 가져왔 들고왔 안고왔`, PAST)
		},
		{
			field: 'hide',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				formalQuestion: words(`감춥니까 숨깁니까 넣어둡니까 간직합니까 묻습니까 챙겨둡니까`),
		...
		},
		{
			...
			words: words(`만든다 짓는다 빚는다 그린다 엮는다 조립한다 깎는다`),
			forms: {
				question: words(`
				...
				`),
				casual: words(
					`만들어|만들지 지어|짓지 빚어|빚지 그려|그리지 엮어|엮지 조립해|조립하지 깎아|깎지`
				),
				polite: words(
					`만들어요|만들죠 지어요|짓죠 빚어요|빚죠 그려요|그리죠 엮어요|엮죠 조립해요|조립하죠 깎아요|깎죠`
				),
				formal: words(`만듭니다 짓습니다 빚습니다 그립니다 엮습니다 조립합니다 깎습니다`),
				formalQuestion: words(`만듭니까 짓습니까 빚습니까 그립니까 엮습니까 조립합니까 깎습니까`),
				linking: words(`만들고 짓고 빚고 그리고 엮고 조립하고 깎고`)
			},
			past: conjugate(`만들었 지었 빚었 그렸 엮었 조립했 깎았`, PAST)
		},
		{
			field: 'tend',
			subject: ['person'],
			...
			forms: {
				...
				formal: words(`고칩니다 닦습니다 손질합니다 다듬습니다 정리합니다 매만집니다 수리합니다`),
				formalQuestion: words(
					`고칩니까 닦습니까 손질합니까 다듬습니까 정리합니까 매만집니까 수리합니까`
				),
				linking: words(`고치고 닦고 손질하고 다듬고 정리하고 매만지고 수리하고`)
			},
			past: conjugate(`고쳤 닦았 손질했 다듬었 정리했 매만졌 수리했`, PAST)
		},
		{
			field: 'sell',
			subject: ['person'],
			...
			forms: {
				...
				casual: words(`팔아|팔지 넘겨|넘기지 건네|건네지 내놓아|내놓지`),
				polite: words(`팔아요|팔죠 넘겨요|넘기죠 건네요|건네죠 내놓아요|내놓죠`),
				formal: words(`팝니다 넘깁니다 건넵니다 내놓습니다`),
				formalQuestion: words(`팝니까 넘깁니까 건넵니까 내놓습니까`),
				linking: words(`팔고 넘기고 건네고 내놓고`)
			},
			past: conjugate(`팔았 넘겼 건넸 내놓았`, PAST)
		},
		{
			field: 'buy',
			subject: ['person'],
			...
			forms: {
				...
				casual: words(`사|사지 사와|사오지 구해|구하지 장만해|장만하지 사들여|사들이지`),
				polite: words(`사요|사죠 사와요|사오죠 구해요|구하죠 장만해요|장만하죠 사들여요|사들이죠`),
				formal: words(`삽니다 사옵니다 구합니다 장만합니다 사들입니다`),
				formalQuestion: words(`삽니까 사옵니까 구합니까 장만합니까 사들입니까`),
				linking: words(`사서|사고 사와서|사오고 구해서|구하고 장만해서|장만하고 사들여서|사들이고`)
			},
			past: conjugate(`샀 사왔 구했 장만했 사들였`, PAST)
		},
		{
			field: 'cook',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				`),
				casual: words(`구워|굽지 데워|데우지 끓여|끓이지 요리해|요리하지 썰어|썰지 담아|담지`),
				polite: words(
			...
			past: conjugate(`구웠 데웠 끓였 요리했 썰었 담았`, PAST)
		},
		{
			field: 'eat',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				formalQuestion: words(`먹습니까 씹습니까 삼킵니까 맛봅니까 베어먹습니까 먹어치웁니까`),
				linking: words(`먹고 씹고 삼키고 맛보고 베어먹고 먹어치우고`)
			},
			past: conjugate(`먹었 씹었 삼켰 맛봤 베어먹었 먹어치웠`, PAST)
		},
		{
			field: 'drink',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				casual: words(`마셔|마시지 들이켜|들이키지 홀짝여|홀짝이지 음미해|음미하지`),
				polite: words(`마셔요|마시죠 들이켜요|들이키죠 홀짝여요|홀짝이죠 음미해요|음미하죠`),
				formal: words(`마십니다 들이킵니다 홀짝입니다 음미합니다`),
				formalQuestion: words(`마십니까 들이킵니까 홀짝입니까 음미합니까`),
				linking: words(`마시고 들이키고 홀짝이고 음미하고`)
			},
			past: conjugate(`마셨 들이켰 홀짝였 음미했`, PAST)
		},
		...
		// two are apart — a market does not set the way a day does.
		{
			field: 'change',
			subject: ['place'],
			words: words(`조용해진다 어두워진다 밝아온다 고요해진다 붐빈다 물든다 환해진다 잠잠해진다`),
			forms: {
				question: words(`
			...
			past: conjugate(`조용해졌 어두워졌 밝아왔 고요해졌 붐볐 물들었 환해졌 잠잠해졌`, PAST)
		},
		{
			field: 'change',
			subject: ['event'],
		...
		},
		{
			...
			forms: {
				...
				formal: words(`흔들립니다 반짝입니다 떨어집니다 굴러갑니다 기울어집니다 낡아갑니다`),
				formalQuestion: words(
		...
		},
		{
			...
			forms: {
				...
				formalQuestion: words(`달립니까 멈춥니까 지나갑니까 돌아옵니까 출발합니까 미끄러집니까`),
				linking: words(`달리고 멈추고 지나가고 돌아오고 출발하고 미끄러지고`)
			},
			past: conjugate(`달렸 멈췄 지나갔 돌아왔 출발했 미끄러졌`, PAST)
		},
		{
			field: 'change',
			subject: ['idea', 'event'],
			...
			forms: {
				...
				formalQuestion: words(`번집니까 사라집니까 남습니까 스며듭니까 되풀이됩니까 짙어집니까`),
				linking: words(`번지고 사라지고 남고 스며들고 되풀이되고 짙어지고`)
			},
			past: conjugate(`번졌 사라졌 남았 스며들었 되풀이됐 짙어졌`, PAST)
		},
		{
			field: 'change',
			subject: ['plant'],
			...
			past: conjugate(`자랐 시들었 피어났 흔들렸 뿌리내렸`, PAST)
		},
		{
			field: 'change',
			subject: ['body'],
			...
			forms: {
				...
				casual: words(`떨려|떨리지 움직여|움직이지 저려|저리지 굳어|굳지`),
				polite: words(`떨려요|떨리죠 움직여요|움직이죠 저려요|저리죠 굳어요|굳죠`),
				formal: words(`떨립니다 움직입니다 저립니다 굳습니다`),
				formalQuestion: words(`떨립니까 움직입니까 저립니까 굳습니까`),
				linking: words(`떨리고 움직이고 저리고 굳고`)
			},
			past: conjugate(`떨렸 움직였 저렸 굳었`, PAST)
		},
		{
			field: 'change',
			subject: ['edible'],
			...
			forms: {
				...
				casual: words(`익어|익지 식어|식지 끓어|끓지 녹아|녹지 상해|상하지 남아|남지`),
				polite: words(`익어요|익죠 식어요|식죠 끓어요|끓죠 녹아요|녹죠 상해요|상하죠 남아요|남죠`),
	...
	states: [
		{
			...
			forms: {
				...
				exclamation: words(`
					...
					게으르구나|게으르네|게으르군 부지런하구나|부지런하네|부지런하군 사납구나|사납네|사납군 순하구나|순하네|순하군 영리하구나|영리하네|영리하군
				`),
				casual: words(`
			...
			past: conjugate(
				`컸 작았 빨랐 느렸 조용했 시끄러웠 용감했 게을렀 부지런했 사나웠 순했 영리했`,
				PAST
			)
		},
		{
			...
			forms: {
				...
				casual: words(`배고파|배고프지 허기져|허기지지`),
				polite: words(`배고파요|배고프죠 허기져요|허기지죠`),
				formal: words(`배고픕니다 허기집니다`),
				formalQuestion: words(`배고픕니까 허기집니까`)
			},
			past: conjugate(`배고팠 허기졌`, PAST)
		},
		{
			subject: ['creature', 'person'],
			condition: 'full',
			...
			forms: {
				...
				casual: words(`배불러|배부르지 든든해|든든하지`),
				polite: words(`배불러요|배부르죠 든든해요|든든하죠`),
				formal: words(`배부릅니다 든든합니다`),
				formalQuestion: words(`배부릅니까 든든합니까`)
			},
			past: conjugate(`배불렀 든든했`, PAST)
		},
		{
			subject: ['creature', 'person'],
			condition: 'tired',
			...
			forms: {
				question: words(`피곤하니|피곤한가 졸리니|졸린가 나른하니|나른한가 고단하니|고단한가`),
				exclamation: words(
					`피곤하구나|피곤하네|피곤하군 졸리구나|졸리네|졸리군 나른하구나|나른하네|나른하군 고단하구나|고단하네|고단하군`
				),
				casual: words(`피곤해|피곤하지 졸려|졸리지 나른해|나른하지 고단해|고단하지`),
				polite: words(`피곤해요|피곤하죠 졸려요|졸리죠 나른해요|나른하죠 고단해요|고단하죠`),
				formal: words(`피곤합니다 졸립니다 나른합니다 고단합니다`),
				formalQuestion: words(`피곤합니까 졸립니까 나른합니까 고단합니까`)
			},
			past: conjugate(`피곤했 졸렸 나른했 고단했`, PAST)
		},
		{
			subject: ['creature', 'person'],
			condition: 'rested',
			...
			forms: {
				...
				casual: words(`상쾌해|상쾌하지 개운해|개운하지 활기차|활기차지`),
				polite: words(`상쾌해요|상쾌하죠 개운해요|개운하죠 활기차요|활기차죠`),
				formal: words(`상쾌합니다 개운합니다 활기찹니다`),
				formalQuestion: words(`상쾌합니까 개운합니까 활기찹니까`)
			},
			past: conjugate(`상쾌했 개운했 활기찼`, PAST)
		},
		{
			subject: ['creature', 'person'],
			condition: 'content',
			...
			forms: {
				...
				exclamation: words(`
					기쁘구나|기쁘네|기쁘군 즐겁구나|즐겁네|즐겁군 편안하구나|편안하네|편안하군 만족스럽구나|만족스럽네|만족스럽군 행복하구나|행복하네|행복하군 뿌듯하구나|뿌듯하네|뿌듯하군
				`),
				casual: words(
				...
				formal: words(`기쁩니다 즐겁습니다 편안합니다 만족스럽습니다 행복합니다 뿌듯합니다`),
				formalQuestion: words(`기쁩니까 즐겁습니까 편안합니까 만족스럽습니까 행복합니까 뿌듯합니까`)
			},
			past: conjugate(`기뻤 즐거웠 편안했 만족스러웠 행복했 뿌듯했`, PAST)
		},
		{
			subject: ['creature', 'person'],
			condition: 'restless',
			...
			forms: {
				question: words(`심심하니|심심한가 궁금하니|궁금한가 초조하니|초조한가 답답하니|답답한가`),
				exclamation: words(
					`심심하구나|심심하네|심심하군 궁금하구나|궁금하네|궁금하군 초조하구나|초조하네|초조하군 답답하구나|답답하네|답답하군`
				),
				casual: words(`심심해|심심하지 궁금해|궁금하지 초조해|초조하지 답답해|답답하지`),
				polite: words(`심심해요|심심하죠 궁금해요|궁금하죠 초조해요|초조하죠 답답해요|답답하죠`),
				formal: words(`심심합니다 궁금합니다 초조합니다 답답합니다`),
				formalQuestion: words(`심심합니까 궁금합니까 초조합니까 답답합니까`)
			},
			past: conjugate(`심심했 궁금했 초조했 답답했`, PAST)
		},
		{
			subject: [
				'creature',
			...
			forms: {
				...
				casual: words(`아름다워|아름답지 낯설어|낯설지 새로워|새롭지 흔해|흔하지 드물어|드물지`),
				polite: words(
		...
		},
		{
			...
			forms: {
				question: words(`푸르니|푸른가 무성하니|무성한가 향기로우니|향기로운가 시들하니|시들한가`),
				exclamation: words(
					`푸르구나|푸르네|푸르군 무성하구나|무성하네|무성하군 향기롭구나|향기롭네|향기롭군 시들하구나|시들하네|시들하군`
				),
				casual: words(`푸르러|푸르지 무성해|무성하지 향기로워|향기롭지 시들해|시들하지`),
				polite: words(`푸르러요|푸르죠 무성해요|무성하죠 향기로워요|향기롭죠 시들해요|시들하죠`),
				formal: words(`푸릅니다 무성합니다 향기롭습니다 시들합니다`),
				formalQuestion: words(`푸릅니까 무성합니까 향기롭습니까 시들합니까`)
			},
			past: conjugate(`푸르렀 무성했 향기로웠 시들했`, PAST)
		},
		{
			subject: ['body'],
			words: words(`따뜻하다 차갑다 아프다 뻣뻣하다`),
			forms: {
				question: words(`따뜻하니|따뜻한가 차가우니|차가운가 아프니|아픈가 뻣뻣하니|뻣뻣한가`),
				exclamation: words(
					`따뜻하구나|따뜻하네|따뜻하군 차갑구나|차갑네|차갑군 아프구나|아프네|아프군 뻣뻣하구나|뻣뻣하네|뻣뻣하군`
				),
				casual: words(`따뜻해|따뜻하지 차가워|차갑지 아파|아프지 뻣뻣해|뻣뻣하지`),
				polite: words(`따뜻해요|따뜻하죠 차가워요|차갑죠 아파요|아프죠 뻣뻣해요|뻣뻣하죠`),
				formal: words(`따뜻합니다 차갑습니다 아픕니다 뻣뻣합니다`),
				formalQuestion: words(`따뜻합니까 차갑습니까 아픕니까 뻣뻣합니까`)
			},
			past: conjugate(`따뜻했 차가웠 아팠 뻣뻣했`, PAST)
		}
	],
	...
	modifiers: [
		...
		{ subject: ['creature'], words: words(`날쌘 사나운 순한 겁많은 통통한 조그만`) },
		{
			...
			themes: ['food'],
			words: words(
				`달콤한 매콤한 따뜻한 신선한 바삭한 고소한 향긋한 뜨거운 짭짤한 말랑한 촉촉한 새콤한 잘익은 먹음직한 담백한`
			)
		},
		{
			subject: ['edible'],
		...
		{ subject: ['body'], words: words(`작은 차가운 따뜻한 가느다란 튼튼한 여린`) },
		{
			subject: [
				'creature',
				'person',
