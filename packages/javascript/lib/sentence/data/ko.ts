	...
	verbs: [
		{
			...
			forms: {
				...
				casualQuestion: words(`일어나|일어나지 일어서|일어서지 깨어나|깨어나지 눈떠|눈뜨지`),
		...
		// their own. `향한다` wants a `시장으로` in front of it; `떠난다` does not.
		{
			...
			forms: {
				...
				`),
				casual: words(`가 향해 달려가 올라가 내려가`),
				casualQuestion: words(
					`가|가지 향해|향하지 달려가|달려가지 올라가|올라가지 내려가|내려가지`
				),
				polite: words(`가요 향해요 달려가요 올라가요 내려가요`),
				politeQuestion: words(
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`떠나|떠나지 나서|나서지 출발해|출발하지 길을떠나|길을떠나지`),
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`돌아와|돌아오지 도착해|도착하지 돌아가|돌아가지 귀가해|귀가하지`),
		...
		},
		{
			...
			subject: ['creature', 'person'],
			words: words(
				`달린다 걷는다 뛴다 헤엄친다 기어간다 서성인다 지나간다 어슬렁댄다 뛰어다닌다 거닌다 산책한다`
			),
			forms: {
				question: words(`
				...
				`),
				casual: words(`달려 걸어 뛰어 헤엄쳐 기어가 서성여 지나가 어슬렁대 뛰어다녀 거닐어 산책해`),
				casualQuestion: words(`
					달려|달리지 걸어|걷지 뛰어|뛰지 헤엄쳐|헤엄치지 기어가|기어가지 서성여|서성이지 지나가|지나가지 어슬렁대|어슬렁대지 뛰어다녀|뛰어다니지 거닐어|거닐지
					산책해|산책하지
				`),
				polite: words(
					`달려요 걸어요 뛰어요 헤엄쳐요 기어가요 서성여요 지나가요 어슬렁대요 뛰어다녀요 거닐어요 산책해요`
				),
				politeQuestion: words(`
				...
				`),
				formal: words(
					`달립니다 걷습니다 뜁니다 헤엄칩니다 기어갑니다 서성입니다 지나갑니다 어슬렁댑니다 뛰어다닙니다 거닙니다 산책합니다`
				),
				formalQuestion: words(
					`달립니까 걷습니까 뜁니까 헤엄칩니까 기어갑니까 서성입니까 지나갑니까 어슬렁댑니까 뛰어다닙니까 거닙니까 산책합니까`
				),
				linking: words(
					`달리고 걷고 뛰고 헤엄치고 기어가고 서성이고 지나가고 어슬렁대고 뛰어다니고 거닐고 산책하고`
				)
			},
			past: conjugate(
				`달렸 걸었 뛰었 헤엄쳤 기어갔 서성였 지나갔 어슬렁댔 뛰어다녔 거닐었 산책했`,
				PAST
			)
		},
		{
			// Taking off is a creature's alone: a person does not fly.
			field: 'move',
			subject: ['creature'],
			words: words(`날아오른다`),
			forms: {
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`쉬어|쉬지 앉아|앉지 누워|눕지 웅크려|웅크리지 드러누워|드러눕지`),
			...
			past: conjugate(`쉬었 앉았 누웠 웅크렸 드러누웠`, PAST)
		},
		{
			field: 'sleep',
			subject: ['creature', 'person'],
			...
			forms: {
				...
				politeQuestion: words(`잠자요|잠자죠 잠들어요|잠들죠 졸아요|졸죠 꾸벅여요|꾸벅이죠`),
		...
		},
		{
			...
			forms: {
				...
				`),
				polite: words(`춤춰요 노래해요 뒹굴어요 뛰놀아요 장난쳐요 뛰어올라요 폴짝거려요 굴러요`),
				politeQuestion: words(`
		...
		},
		{
			...
			forms: {
				...
				`),
				polite: words(`꿈꿔요 기억해요 잊어요 상상해요 헤아려요 떠올려요 그리워해요 궁금해해요`),
				politeQuestion: words(`
		...
		},
		{
			...
			forms: {
				...
				polite: words(`봐요 바라봐요 살펴요 들여다봐요 구경해요 만져요 쓰다듬어요 지켜봐요`),
				politeQuestion: words(`
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`찾아다녀|찾아다니지 헤매|헤매지 둘러봐|둘러보지 살펴봐|살펴보지`),
		...
		},
		{
			...
			forms: {
				...
				politeQuestion: words(`찾아요|찾죠 발견해요|발견하죠 주워요|줍죠 찾아내요|찾아내죠`),
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`사|사지 사와|사오지 구해|구하지 장만해|장만하지 사들여|사들이지`),
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`마셔|마시지 들이켜|들이키지 홀짝여|홀짝이지 음미해|음미하지`),
		...
		},
		{
			...
			forms: {
				...
				politeQuestion: words(`떨려요|떨리죠 움직여요|움직이죠 저려요|저리죠 굳어요|굳죠`),
	...
	states: [
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`피곤해|피곤하지 졸려|졸리지 나른해|나른하지 고단해|고단하지`),
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`심심해|심심하지 궁금해|궁금하지 초조해|초조하지 답답해|답답하지`),
		...
		},
		{
			...
			forms: {
				...
				polite: words(`단단해요 가벼워요 무거워요 매끈해요 투명해요 튼튼해요 반들반들해요`),
				politeQuestion: words(`
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`푸르러|푸르지 무성해|무성하지 향기로워|향기롭지 시들해|시들하지`),
		...
		},
		{
			...
			forms: {
				...
				casualQuestion: words(`따뜻해|따뜻하지 차가워|차갑지 아파|아프지 뻣뻣해|뻣뻣하지`),
				polite: words(`따뜻해요 차가워요 아파요 뻣뻣해요`),
				politeQuestion: words(`따뜻해요|따뜻하죠 차가워요|차갑죠 아파요|아프죠 뻣뻣해요|뻣뻣하죠`),
