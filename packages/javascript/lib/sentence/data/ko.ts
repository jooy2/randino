...
export const KO: SentenceLanguageData = {
	...
	verbs: [
		...
		},
		{
			...
			...koVerbs(`달려가:달려가:서 걸어가:걸어가:서 뛰어가:뛰어가:서 서둘러가:서둘러가:서`)
		},
		{
			field: 'go',
			subject: ['creature', 'person'],
		...
		},
		{
			...
			subjectWithout: ['swimmer', 'crawler'],
			...koVerbs(
				`달리:달려 걷:걸어 뛰:뛰어 서성이:서성여 지나가:지나가 어슬렁대:어슬렁대 뛰어다니:뛰어다녀 거닐:거닐어 산책하:산책해 돌아다니:돌아다녀 뛰어나가:뛰어나가 걸어다니:걸어다녀 껑충뛰:껑충뛰어 성큼성큼걷:성큼성큼걸어 종종걸음치:종종걸음쳐 활보하:활보해 질주하:질주해 배회하:배회해 총총거리:총총거려 내달리:내달려 뛰쳐나가:뛰쳐나가 발을구르:발을굴러`
			)
		},
		{
			field: 'move',
		...
		},
		{
			...
			...koVerbs(
				`헤엄치:헤엄쳐 유영하:유영해 자맥질하:자맥질해 헤엄쳐다니:헤엄쳐다녀 물장구치:물장구쳐`
			)
		},
		{
			field: 'move',
			...
			...koVerbs(
				`기어가:기어가 기어다니:기어다녀 꿈틀거리:꿈틀거려 기어오르:기어올라 기어나오:기어나와`
			)
		},
		{
		...
		},
		{
			...
			subject: ['creature', 'person'],
			...koVerbs(
				`웃:웃어 울:울어 하품하:하품해 한숨짓:한숨지어 미소짓:미소지어 콧노래하:콧노래해 중얼거리:중얼거려 소리치:소리쳐 킥킥거리:킥킥거려 깔깔대:깔깔대 흐느끼:흐느껴 투덜거리:투덜거려 혼잣말하:혼잣말해 환호하:환호해 탄식하:탄식해 히죽거리:히죽거려 훌쩍이:훌쩍여 고개를끄덕이:고개를끄덕여 어깨를으쓱하:어깨를으쓱해 흥얼거리:흥얼거려 재채기하:재채기해 눈물짓:눈물지어 외치:외쳐 웃음짓:웃음지어 고개를젓:고개를저어 손뼉치:손뼉쳐`
			)
		},
		{
			field: 'talk',
			subject: ['creature', 'person'],
			...koVerbs(
				`이야기하:이야기해 수다떨:수다떨어 대화하:대화해 말하:말해 담소하:담소해 잡담하:잡담해 떠들:떠들어 속삭이:속삭여 재잘거리:재잘거려 얘기하:얘기해 수군거리:수군거려 이야기를나누:이야기를나눠 말을건네:말을건네`
			)
		},
		{
			field: 'play',
			subject: ['creature', 'person'],
			...koVerbs(
				`춤추:춤춰 노래하:노래해 뒹굴:뒹굴어 뛰놀:뛰놀아 장난치:장난쳐 뛰어오르:뛰어올라 폴짝거리:폴짝거려 구르:굴러 놀:놀아 뛰어놀:뛰어놀아 까불:까불어 재롱부리:재롱부려 깡충거리:깡충거려 숨바꼭질하:숨바꼭질해 신나하:신나해 물장난치:물장난쳐 공놀이하:공놀이해 노닐:노닐어 재주넘:재주넘어 빙글빙글돌:빙글빙글돌아`
			)
		},
		{
			field: 'think',
		...
		},
		{
			...
			subject: ['creature', 'person'],
			...koVerbs(
				`찾아다니:찾아다녀 헤매:헤매 둘러보:둘러봐 살펴보:살펴봐 뒤지:뒤져 뒤적이:뒤적여 수색하:수색해 탐색하:탐색해 물색하:물색해 더듬:더듬어 샅샅이뒤지:샅샅이뒤져 파헤치:파헤쳐 탐험하:탐험해 살펴다니:살펴다녀 찾아헤매:찾아헤매`
			)
		},
		{
			field: 'find',
		...
		},
		{
			...
			...koVerbs(
				`조립하:조립해 깎:깎아 조각하:조각해 용접하:용접해 설계하:설계해 제작하:제작해 제조하:제조해`
			)
		},
		{
			field: 'tend',
		...
		},
		{
			...
			objectThemes: ['drink'],
			...koVerbs(
				`마시:마셔 들이키:들이켜 홀짝이:홀짝여 음미하:음미해 마셔보:마셔봐 벌컥벌컥마시:벌컥벌컥마셔 꿀꺽꿀꺽마시:꿀꺽꿀꺽마셔 한모금마시:한모금마셔 들이마시:들이마셔 마셔버리:마셔버려 홀짝거리:홀짝거려 다마시:다마셔 한잔하:한잔해 맛보:맛봐`
			)
		},
