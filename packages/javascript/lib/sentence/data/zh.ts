...
export const ZH: SentenceLanguageData = {
	...
	traits: {
		...
		lifeless: words(`
			...
			仙丹 法宝 魔杖 水晶球 魔镜 飞毯 圣杯 符文 魔药 鬼火 龙宫 天宫
		`),
		...
		placeless: words(`
			...
			浪花 泡沫 漩涡 激流 雪崩 泥石流 洪水 海啸 岩浆 涟漪 泥土 尘土 火焰 火花 篝火 烟雾 化石 海平线 日出 日落 星星 星图 北斗星 牛郎星 织女星 天狼星 启明星 仙女座 猎户座 残月 月相 月壤
			耀斑 反物质 暗物质 暗能量 白矮星 红巨星 中子星 脉冲星 双星 光速 大爆炸 时空 土星环 凌日
		`)
	},
	interjections: words(`
