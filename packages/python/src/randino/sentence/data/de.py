...
DE = SentenceLanguageData(
    ...
    replies={
        "casual": {
            ...
            """),
            "cheer": words("""
                wie_schön! gut_gemacht! großartig! du_Glückspilz prima! Glückwunsch
                was_für_eine_Freude! wunderbar! endlich! das_freut_mich
            """),
            "care": words("""
            ...
            """),
            "wonder": words("""
                wirklich? im_Ernst? wo? wann? und_dann? das_gibt's_nicht! wie? warum? ach_ja?
                und_danach? was_ist_passiert? was?
            """),
            "answer": words("""
                ja,_ein_bisschen nein,_alles_gut ja,_ziemlich geht_so nein,_noch_nicht ja,_sehr
                ein_wenig nicht_wirklich ja,_total nein,_gar_nicht so_lala ja,_ehrlich_gesagt
            """),
        },
    },
    listener=SentenceSpeech(subject="du", head="bist"),
    homecomings={
        "casual": words("""
    ...
    degrees=words("""
        sehr ziemlich wirklich ganz recht etwas äußerst ungemein reichlich furchtbar
    """),
