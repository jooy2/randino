...
class SentenceLanguageData:
    ...
    homecomings: Mapping[str, WordPool] | None = None
    """What somebody says on coming home, by speech level: `다녀왔어`, `ただいま`, `I'm home`.

    Written whole, because it is an idiom and not a sentence about arriving — `집에
    도달했습니다` is grammar and nobody says it. A line that reports coming home is drawn
    from here, in every language that declares it, whether or not the language writes a
    first person. None for a language that has no such saying.
    """
