...
KO = SentenceLanguageData(
    ...
    verbs=(
        ...
        VerbGroup(
            ...
            past=conjugate("갔 향했 달려갔 올라갔 내려갔", _PAST),
        ),
        VerbGroup(
            field="go",
            subject=("creature", "person"),
        ...
        VerbGroup(
            ...
            forms={
                "question": words("""
                    ...
                    지나가니|지나가나|지나가는가 어슬렁대니|어슬렁대나|어슬렁대는가 뛰어다니니|뛰어다니나|뛰어다니는가 거니니|거니나|거니는가
                    산책하니|산책하나|산책하는가
                """),
                "exclamation": words("""
                ...
                """),
                "casual": words(
                    "달려 걸어 뛰어 헤엄쳐 기어가 서성여 지나가 어슬렁대 뛰어다녀 거닐어 산책해"
                ),
                "casualQuestion": words("""
                    달려|달리지 걸어|걷지 뛰어|뛰지 헤엄쳐|헤엄치지 기어가|기어가지 서성여|서성이지 지나가|지나가지 어슬렁대|어슬렁대지 뛰어다녀|뛰어다니지
                    거닐어|거닐지 산책해|산책하지
                """),
                "polite": words(
                ...
                "politeQuestion": words("""
                    달려요|달리죠 걸어요|걷죠 뛰어요|뛰죠 헤엄쳐요|헤엄치죠 기어가요|기어가죠 서성여요|서성이죠 지나가요|지나가죠 어슬렁대요|어슬렁대죠
            ...
            past=conjugate(
                "달렸 걸었 뛰었 헤엄쳤 기어갔 서성였 지나갔 어슬렁댔 뛰어다녔 거닐었 산책했", _PAST
            ),
        ),
        VerbGroup(
            field="move",
        ...
        VerbGroup(
            ...
            forms={
                "question": words("""
                    빛나니|빛나나|빛나는가 흐르니|흐르나|흐르는가 저무니|저무나|저무는가 깊어지니|깊어지나|깊어지는가 시작되니|시작되나|시작되는가
                    끝나니|끝나나|끝나는가 이어지니|이어지나|이어지는가 지나가니|지나가나|지나가는가
                """),
                "exclamation": words("""
                ...
                """),
                "polite": words(
                    "빛나요 흘러요 저물어요 깊어져요 시작돼요 끝나요 이어져요 지나가요"
                ),
                "politeQuestion": words("""
            ...
            past=conjugate("빛났 흘렀 저물었 깊어졌 시작됐 끝났 이어졌 지나갔", _PAST),
        ),
        VerbGroup(
            field="change",
        ...
        VerbGroup(
            ...
            past=conjugate("익었 식었 끓었 녹았 상했 남았", _PAST),
        ),
    ),
    states=(
        StateGroup(
        ...
        StateGroup(
            ...
            forms={
                ...
                """),
                "exclamation": words("""
                    달구나|다네|달군 짜구나|짜네|짜군 맵구나|맵네|맵군 시구나|시네|시군 뜨겁구나|뜨겁네|뜨겁군 차갑구나|차갑네|차갑군
                    고소하구나|고소하네|고소하군 담백하구나|담백하네|담백하군
                """),
            ...
            past=conjugate("달았 짰 매웠 셨 뜨거웠 차가웠 고소했 담백했", _PAST),
        ),
        StateGroup(
            subject=("idea",),
            ...
            forms={
                ...
                "exclamation": words("""
                    어렵구나|어렵네|어렵군 쉽구나|쉽네|쉽군 분명하구나|분명하네|분명하군 흐릿하구나|흐릿하네|흐릿하군 영원하구나|영원하네|영원하군
                    덧없구나|덧없네|덧없군
                """),
            ...
            past=conjugate("어려웠 쉬웠 분명했 흐릿했 영원했 덧없었", _PAST),
        ),
        StateGroup(
            subject=("plant",),
