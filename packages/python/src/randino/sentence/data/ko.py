...
KO = SentenceLanguageData(
    ...
    verbs=(
        ...
        VerbGroup(
            ...
            subject_without=("swimmer", "crawler"),
            words=words(
                "달린다 걷는다 뛴다 서성인다 지나간다 어슬렁댄다 뛰어다닌다 거닌다 산책한다"
            ),
            forms={
                "question": words("""
                    달리니|달리나|달리는가 걷니|걷나|걷는가 뛰니|뛰나|뛰는가 서성이니|서성이나|서성이는가 지나가니|지나가나|지나가는가
                ...
                "politeQuestion": words("""
                    달려요|달리죠 걸어요|걷죠 뛰어요|뛰죠 서성여요|서성이죠 지나가요|지나가죠 어슬렁대요|어슬렁대죠 뛰어다녀요|뛰어다니죠 거닐어요|거닐죠
                    산책해요|산책하죠
                """),
                "formal": words(
                ...
                "linking": words(
                    "달리고 걷고 뛰고 서성이고 지나가고 어슬렁대고 뛰어다니고 거닐고 산책하고"
                ),
            },
            past=conjugate("달렸 걸었 뛰었 서성였 지나갔 어슬렁댔 뛰어다녔 거닐었 산책했", _PAST),
        ),
        VerbGroup(
            field="move",
            subject=("creature", "person"),
    ...
    states=(
        StateGroup(
            ...
            forms={
                "question": words("""
                    크니|큰가 작니|작은가 빠르니|빠른가 느리니|느린가 조용하니|조용한가 시끄럽니|시끄러운가 용감하니|용감한가 게으르니|게으른가
                    부지런하니|부지런한가 사납니|사나운가 순하니|순한가 영리하니|영리한가
                """),
                "exclamation": words("""
        ...
        StateGroup(
            ...
            forms={
                "question": words(
                    "아름답니|아름다운가 낯서니|낯선가 새롭니|새로운가 흔하니|흔한가 드무니|드문가"
                ),
                "exclamation": words("""
        ...
        StateGroup(
            ...
            forms={
                "question": words("""
                    넓니|넓은가 좁니|좁은가 고요하니|고요한가 깊니|깊은가 어둡니|어두운가 밝니|밝은가 아득하니|아득한가 가파르니|가파른가
                """),
                "exclamation": words("""
        ...
        StateGroup(
            ...
            forms={
                "question": words("""
                    단단하니|단단한가 가볍니|가벼운가 무겁니|무거운가 매끈하니|매끈한가 투명하니|투명한가 튼튼하니|튼튼한가 반들반들하니|반들반들한가
                """),
                "exclamation": words("""
        ...
        StateGroup(
            ...
            forms={
                "question": words("다니|단가 시니|신가 뜨겁니|뜨거운가 차갑니|차가운가"),
                "exclamation": words(
        ...
        StateGroup(
            ...
            forms={
                "question": words("짜니|짠가 맵니|매운가 고소하니|고소한가 담백하니|담백한가"),
                "exclamation": words(
        ...
        StateGroup(
            ...
            forms={
                "question": words(
                    "분명하니|분명한가 흐릿하니|흐릿한가 영원하니|영원한가 덧없니|덧없는가"
                ),
                "exclamation": words(
        ...
        StateGroup(
            ...
            words=words("어렵다 쉽다"),
            forms={
                "question": words("어렵니|어려운가 쉽니|쉬운가"),
        ...
        StateGroup(
            ...
            forms={
                "question": words(
                    "푸르니|푸른가 무성하니|무성한가 향기롭니|향기로운가 시들하니|시들한가"
                ),
                "exclamation": words(
        ...
        StateGroup(
            ...
            forms={
                "question": words(
                    "따뜻하니|따뜻한가 차갑니|차가운가 아프니|아픈가 뻣뻣하니|뻣뻣한가"
                ),
                "exclamation": words(
    ...
    traits={
        ...
        """),
        "lifeless": words("""
            마법 마력 주문 저주 예언 신탁 결계 성배 마검 부적 룬 봉인 환영 마술 도술 술법 마법진 명계 장승 호신부 호부 룬문자 인장술 문양술 저주술 축복술 징조
            전조 예언서 신화집 전설집
        """),
        "placeless": words("""
            얼음 파도 물결 모래 조약돌 지진 밀물 썰물 그림자 메아리 향기 불꽃 잿불 산호 물보라 빙퇴석 너덜 바윗돌 암반 간헐천 분기공 종유석 석순 해일 지평 수평 별
            태양 별자리 유성 오로라 초승달 보름달 별똥별 일식 월식 코로나 극광 별무리 천정 위성 혜성 성단 북극성 샛별 궤도 중력 자전 공전 흑점 태양풍 광년 천체
            성간 항성 성좌 천구 황도 초신성 유성우 우주먼지 그믐달 반달 하현달 상현달 만월 신월 월광 성광
        """),
    },
    interjections=words(
