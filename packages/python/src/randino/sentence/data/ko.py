...
KO = SentenceLanguageData(
    ...
    verbs=(
        ...
        VerbGroup(
            ...
            forms={
                "question": words("""
                    달리니|달리나|달리는가 걷니|걷나|걷는가 뛰니|뛰나|뛰는가 헤엄치니|헤엄치나|헤엄치는가 날아오르니|날아오르나|날아오르는가
                    기어가니|기어가나|기어가는가 서성이니|서성이나|서성이는가 지나가니|지나가나|지나가는가 어슬렁대니|어슬렁대나|어슬렁대는가
                ...
                """),
                "casual": words("""
                    달려|달리지 걸어|걷지 뛰어|뛰지 헤엄쳐|헤엄치지 날아올라|날아오르지 기어가|기어가지 서성여|서성이지 지나가|지나가지 어슬렁대|어슬렁대지
                    뛰어다녀|뛰어다니지 거닐어|거닐지 산책해|산책하지
                """),
                "polite": words("""
                    달려요|달리죠 걸어요|걷죠 뛰어요|뛰죠 헤엄쳐요|헤엄치죠 날아올라요|날아오르죠 기어가요|기어가죠 서성여요|서성이죠 지나가요|지나가죠
                    어슬렁대요|어슬렁대죠 뛰어다녀요|뛰어다니죠 거닐어요|거닐죠 산책해요|산책하죠
                """),
                "formal": words("""
        ...
        VerbGroup(
            ...
            forms={
                ...
                """),
                "exclamation": words("""
                    쉬는구나|쉬네|쉬는군 앉는구나|앉네|앉는군 눕는구나|눕네|눕는군 기대는구나|기대네|기대는군 웅크리는구나|웅크리네|웅크리는군
                    드러눕는구나|드러눕네|드러눕는군
                """),
                "casual": words(
                ...
                "formalQuestion": words(
                    "쉽니까 앉습니까 눕습니까 기댑니까 웅크립니까 드러눕습니까"
                ),
                "linking": words(
                    "쉬고 앉아서|앉고 누워서|눕고 기대고 웅크리고 드러누워서|드러눕고"
                ),
            },
            past=conjugate("쉬었 앉았 누웠 기댔 웅크렸 드러누웠", _PAST),
        ),
        VerbGroup(
            field="sleep",
            subject=("creature", "person"),
        ...
        VerbGroup(
            ...
            forms={
                "question": words("""
                    만드니|만드나|만드는가 짓니|짓나|짓는가 빚니|빚나|빚는가 그리니|그리나|그리는가 엮니|엮나|엮는가 조립하니|조립하나|조립하는가
                    깎니|깎나|깎는가
                """),
                "exclamation": words("""
                    만드는구나|만드네|만드는군 짓는구나|짓네|짓는군 빚는구나|빚네|빚는군 그리는구나|그리네|그리는군 엮는구나|엮네|엮는군
                    조립하는구나|조립하네|조립하는군 깎는구나|깎네|깎는군
                """),
                "casual": words(
                ...
                "formalQuestion": words(
                    "만듭니까 짓습니까 빚습니까 그립니까 엮습니까 조립합니까 깎습니까"
                ),
                "linking": words("만들고 짓고 빚고 그리고 엮고 조립하고 깎고"),
            },
            past=conjugate("만들었 지었 빚었 그렸 엮었 조립했 깎았", _PAST),
        ),
        VerbGroup(
            field="tend",
            subject=("person",),
    ...
    modifiers=(
        ...
        ModifierGroup(
            subject=("body",),
            words=words("작은 차가운 따뜻한 가느다란 튼튼한 여린"),
        ),
        ModifierGroup(
            subject=(
                "creature",
        ...
        copula=StateGroup(
            ...
            past=PredicateTense(
                ...
                forms={
                    ...
                    "casual": words("이었어|이었지"),
                    "polite": words("이었어요|이었죠"),
                    "formal": words("이었습니다"),
