...
ZH = SentenceLanguageData(
    ...
    traits={
        "flier": words("""
            ...
            锹甲 萤火 蜉蝣 苍蝇 蚊子 神龙 火龙 冰龙 黑龙 白龙 青龙 凤凰 妖精 精灵 仙女 天使 天马 神鸟 朱雀 三足乌 蛟龙 鸟女 石像鬼 小恶魔 小妖精 女武神 鸽子 海鸥
            鸳鸯 鲲鹏
        """),
        "swimmer": words("""
            鲸鱼 海豚 鲨鱼 乌龟 海豹 企鹅 青蛙 章鱼 乌贼 海星 螃蟹 龙虾 鲤鱼 三文鱼 鳄鱼 蝌蚪 蟾蜍 雨蛙 鲫鱼 鲶鱼 黑鱼 鳜鱼 青鳉 泥鳅 鳗鱼 海鳗 带鱼 鲅鱼 秋刀鱼
            凤尾鱼 黄鱼 明太鱼 人鱼 美人鱼 海妖 巨乌贼 海兽王 海龟 金鱼 水母
        """),
        "crawler": words("""
            乌龟 蜥蜴 变色龙 蟒蛇 蜗牛 蚂蚁 蜘蛛 螃蟹 鳄鱼 螳螂 蚯蚓 蜈蚣 马陆 蝎子 壁虱 跳蚤 蚕蛹 毛虫 蝾螈 菜花蛇 蝮蛇 毒蛇 眼镜蛇 响尾蛇 鬣蜥 蛇王 海龟 蟑螂
            蛇精
        """),
        "lifeless": words("""
            魔法 魔力 咒语 诅咒 预言 神谕 结界 护符 封印 幻影 陶俑 女神像 御守 咒文字 符咒 阵法 巫术 祈福 前兆 预兆 预言书 神话集 传说集 奇谭集 仙丹 法宝 魔杖
            水晶球 魔镜 飞毯 圣杯 符文 魔药 鬼火 龙宫 天宫
        """),
        "placeless": words("""
            ...
            北极星 日冕 月晕 星轨 浪花 泡沫 漩涡 激流 雪崩 泥石流 洪水 海啸 岩浆 涟漪 泥土 尘土 火焰 火花 篝火 烟雾 化石 海平线 日出 日落 星星 星图 北斗星 牛郎星
            织女星 天狼星 启明星 仙女座 猎户座 残月 月相 月壤 耀斑 反物质 暗物质 暗能量 白矮星 红巨星 中子星 脉冲星 双星 光速 大爆炸 时空 土星环 凌日
        """),
    },
    interjections=words("""
