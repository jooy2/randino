...
def rand_drink(
    *,
    ...
    `rand_word(theme="drink")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_drink(language="ko", count=3)
        ['식혜', '보리차', '막걸리']
        >>> rand_drink(language="en", count=3)
        ['Cider', 'Cordial', 'Lemonade']
    """
    theme: WordThemeOption = "drink"
