...
def rand_word(
    *,
    ...
    Twenty-nine themes, in nine languages. Person names are never used. `theme` picks
    what the words are about; the twenty-nine `rand_…` functions beside this one are the
