...
def rand_toy(
    *,
    ...
    `rand_word(theme="toy")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_toy(language="ko", count=3)
        ['팽이', '연', '딱지']
        >>> rand_toy(language="en", count=3)
        ['Kite', 'Yoyo', 'Domino']
    """
    theme: WordThemeOption = "toy"
