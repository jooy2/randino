...
def rand_tech(
    *,
    ...
    `rand_word(theme="tech")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_tech(language="ko", count=3)
        ['서버', '캐시', '대역']
        >>> rand_tech(language="en", count=3)
        ['Server', 'Cache', 'Subnet']
    """
    theme: WordThemeOption = "tech"
