...
def rand_body(
    *,
    ...
    `rand_word(theme="body")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_body(language="ko", count=3)
        ['손목', '어깨', '심장']
        >>> rand_body(language="en", count=3)
        ['Wrist', 'Shoulder', 'Heart']
    """
    theme: WordThemeOption = "body"
