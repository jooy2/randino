...
def rand_space(
    *,
    ...
    `rand_word(theme="space")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_space(language="ko", count=3)
        ['은하', '혜성', '북극성']
        >>> rand_space(language="en", count=3)
        ['Galaxy', 'Comet', 'Nebula']
    """
    theme: WordThemeOption = "space"
