...
EN = WordLanguageData(
    ...
    nouns={
        "animal": words("""
            Lion Tiger Leopard Cheetah Fox Wolf Bear Panda Otter Rabbit Squirrel Cat
            Puppy Whale Dolphin Shark Turtle Seal Penguin Owl Sparrow Magpie Swallow
            Eagle Falcon Crane Swan Duck Goose Woodpecker Parrot Peacock Ostrich Horse
            Deer Elephant Giraffe Hippo Monkey Gorilla Frog Lizard Chameleon Snake
            Butterfly Moth Bee Dragonfly Ladybug Snail Ant Spider Octopus Squid Seahorse
            Starfish Crab Shrimp Carp Salmon Mackerel Hedgehog Raccoon Badger Lynx Bison
            Moose Camel Koala Sloth Ferret Mole Bat Heron Pelican Walrus Narwhal Weasel
            Gazelle Zebra Buffalo Raven Kestrel Puffin Flamingo Firefly Mantis Jellyfish
            Chipmunk Jaguar Cougar Bobcat Hyena Jackal Coyote Dingo Meerkat Mongoose
            Marten Wolverine Beaver Porcupine Armadillo Anteater Lemur Baboon Macaque
            Marmoset Tapir Okapi Ibex Chamois Antelope Impala Wildebeest Llama Alpaca
            Donkey Pony Foal Piglet Lamb Kitten Duckling Gosling Cygnet Osprey Vulture
            Condor Stork Ibis Cormorant Albatross Petrel Sandpiper Plover Lapwing
        ...
        "object": words("""
            ...
            Satchel Cap Boot Goggles Bangle Button Thread Brush Paint Paper Notebook
            Bookmark Letter Postcard Postage Compass Atlas Telescope Microscope Camera
            Reel Radio Gramophone Spindle
            Sail Anchor Beacon Tent Backpack Bedroll Torch Matchbox Candle Flowerpot
            Kettle Teacup Spoon Plate Saucepan Hatchet Handsaw Cogwheel Mainspring
            Magnet Ribbon Envelope Basket Broom Whistle Knot Bucket Easel
            Flask Goblet Hourglass Inkwell Quiver Sundial Parasol Thimble Bobbin Loom
            Tongs Mallet Rasp File Sharpener Inkpot Quill Nib Blotter Folder Binder
            Clipboard Notepad Paperclip Pushpin Tack Rivet Bolt Screw Bracket Hinge
        ...
        "nature": words("""
            ...
            Glacier Reef Marshland Prairie Canyon Echo Shadow Avalanche Tundra Oasis
            Lagoon Geyser Plateau Driftwood Steppe Savanna Wetland Swampland Bayou
            Estuary Delta Atoll Fjord Inlet Cove Headland Peninsula Isthmus Archipelago
        ...
        "plant": words("""
            ...
            Azalea Hyacinth Daffodil Snowdrop Bluebell Foxglove Marigold Lavender
            Primrose Buttercup Cowslip Columbine Larkspur Wisteria Begonia Petunia
            Zinnia Dahlia Anemone Crocus Freesia Gardenia Birch Cedar Pine Oak Elm Beech
            Alder Poplar Aspen Cypress Sequoia Sycamore Hawthorn Acorn Chestnut Walnut
            Sprout Sapling Stalk Stem Twig Bark Bud Pollen Nectar Frond Cactus Toadstool
            Lichen Seaweed Kelp Bonsai Hedge Shrub Bramble Thistle Bulrush Sedge Vine
            Nettle Redwood Spruce Larch Olive Hickory Linden Mulberry Mangrove Papyrus
            Duckweed Watercress Mistletoe Wormwood Foxtail Cattail Sepal Stamen Pistil
            Calyx Husk Kernel Tendril Rhizome Tuber Sprig Foliage Canopy Undergrowth
            Arbor Trellis Bough Lilac Carnation Gladiolus Hydrangea Oleander Hibiscus
            Honeysuckle Blackthorn Elderberry Dogwood Geranium Delphinium Lupine Aster
        ...
        "gem": words("""
            ...
            Quartz Amethyst Crystal Topaz Garnet Sapphire Emerald Jade Onyx Obsidian
            Marble Granite Limestone Sandstone Slate Basalt Flint Amber Coral Ivory
            Agate Carnelian Peridot Zircon Turquoise Malachite Lapis Mica Pyrite Gypsum
            Chalk Ore Nugget Gemstone Geode Meteorite Diamond Prism Alloy Ingot
            Aquamarine Tourmaline Tanzanite Moonstone Sunstone Bloodstone Azurite
            Chalcedony Citrine Morganite Kunzite Spinel Alexandrite Chrysoprase
            Rhodonite Sodalite Labradorite Amazonite Aventurine Hematite Magnetite
            Galena Bauxite Cinnabar Realgar Orpiment Barite Celestite Apatite Beryl
            Corundum Olivine Pyroxene Amphibole Serpentine Chlorite Kaolin Bentonite
            Zeolite Cobalt Chromium Manganese Tungsten Antimony Bismuth Cadmium Iridium
        ...
        "concept": words("""
            ...
            Logic Physics Chemistry Biology Philosophy Mathematics Geometry Algebra
            History Myth Legend Fable Proverb Riddle Secret Promise Journey Adventure
            Voyage Discovery Experiment Question Answer Debate Council Festival
            Dimension Balance Harmony Palette Contrast Ritual Custom Culture Language
            Alphabet Cipher Archive Almanac Calendar Paradox Enigma Odyssey Symmetry
            Spectrum Horizon Sanctuary Insight Intuition Reason Judgment Doctrine
            Theorem Axiom Corollary Hypothesis Dilemma Paradigm Framework Premise
            Inference Deduction Induction Analogy Metaphor Allegory Symbol Motif Theme
        ...
        "myth": words("""
            ...
            Minotaur Centaur Satyr Cyclops Titan Ogre Imp Demon Angel Seraph Wraith
            Ghost Phantom Specter Banshee Vampire Werewolf Zombie Mummy Gargoyle Unicorn
            Pegasus Sphinx Djinn Genie Leviathan Behemoth Thunderbird Yeti Spell Curse
            Hex Rune Amulet Talisman Grimoire Potion Oracle Prophecy Sorcery Enchantment
            Revenant Lich Witch Wyrm Dryad Naiad Harpy Gorgon Faun Cerberus Valkyrie
            Norn Fury Muse Augur Warlock Enchanter Conjurer Necromancer Sigil Glyph Omen
            Portent Blessing Homunculus Kobold Gnome Poltergeist Ifrit Shade Wisp
            Barghest Selkie Kelpie Wendigo Chupacabra Roc Simurgh Salamander Undine
        ...
        "job": words("""
            ...
            Alchemist Archer Swordsman Warrior Soldier Guard Sentinel Warden Guardian
            Queen Prince Princess Emperor Steward Servant Maid Merchant Trader Farmer
            Angler Shepherd Woodcutter Ferryman Coachman Navigator Pilot Engineer
            Courier Janitor Firefighter Officer Doctor Nurse Pharmacist Teacher Student
            Librarian Reporter Writer Editor Translator Singer Actor Director Minstrel
            Miner Carpenter Potter Tailor Weaver Seer Prophet Priest Shaman Scholar
            Inventor Explorer Traveler Athlete Referee Juggler Acrobat Sculptor Paladin
            Cavalier Squire Crusader Herald Scribe Barkeep Innkeeper Huntsman
            Stonecutter Archivist Curator Conservator Geologist Astronomer Botanist
            Zoologist Marine Chemist Physicist Actuary Economist Sociologist Linguist
            Philologist Historian Proofreader Typesetter Illustrator Animator Playwright
            Novelist Columnist Broadcaster Announcer Interpreter Diplomat Notary
            Paralegal Prosecutor Magistrate Bailiff Auditor Bookkeeper Appraiser
            Underwriter Broker Realtor Surveyor Draftsman Millwright Machinist Welder
        ...
        "music": words("""
            ...
            Tambourine Maracas Cymbal Bagpipe Organ Kalimba Sitar Lute Lyre Zither
            Ocarina Bugle Sonata Symphony Concerto Overture Prelude Interlude Refrain
            Chorus Anthem Serenade Nocturne Rhapsody Etude Fugue Octave Tempo Cadence
            Crescendo Staccato Encore Duet Trio Quartet Songbook Hymn Carol Chant
            Requiem Cantata Oratorio Madrigal Quintet Ensemble Orchestra Choir Soloist
            Conductor Verse Coda Diminuendo Legato Vibrato Tremolo Glissando Arpeggio
            Semitone Scale Mode Key Clef Stave Notation Score Sheet Metronome Tuner
            Pedal Bow String Fretboard Soundhole Mouthpiece Valve Snare Bassline
            Downbeat Upbeat Syncopation Jamming Busking Ovation Recital Fanfare Toccata
        ...
        "place": words("""
            ...
            Theater Schoolyard Parkland Harbor Wharf Pier Station Airport Lighthouse
        ...
        "food": words("""
            ...
            Waffle Doughnut Cookie Biscuit Cupcake Brownie Pudding Custard Pastry
            Croissant Bagel Pretzel Sandwich Burger Pizza Pasta Spaghetti Lasagna
            Risotto Curry Stew Chowder Salad Pickle Sausage Bacon Steak Meatball
            Barbecue Taco Burrito Sushi Tempura Kimchi Tofu Potato Carrot Cabbage
        ...
        "sport": words("""
            ...
            Squash Golf Bowling Billiards Swimming Athletics Marathon Sprint Gymnastics
            Taekwondo Judo Karate Kendo Boxing Wrestling Fencing Archery Shooting
            Equestrian Rowing Canoeing Sailing Surfing Skiing Snowboard Hockey Rugby
            Cricket Cycling Climbing Racket Goalpost Medal Trophy Podium Playoff
            Overtime Champion Polo Curling Skating Diving Triathlon Softball Netball
            Lacrosse Snooker Darts Jogging Hurdle Javelin Discus Relay Scoreboard Dugout
            Paddle Karting Rafting Dribble Penalty Offside Halftime Kickoff Rebound
            Homerun Slalom Freestyle Backstroke Sprinter Bobsleigh Luge Vaulting Dunk
            Volley Decathlon Biathlon Kayaking Bouldering Parkour Skydiving Paragliding
        ...
        "vehicle": words("""
            ...
            Skateboard Airplane Helicopter Jetliner Spaceship Rocket Submarine Steamship
            Sailboat Raft Kayak Ferry Freighter Warship Galleon Chariot Wagon Cart
            Handcart Tractor Bulldozer Firetruck Ambulance Cruiser Cablecar Subway
            Tramcar Railcar Carriage Sleigh Airship Glider Parachute Gondola Minivan
            Pickup Limousine Convertible Snowplow Monorail Trolley Rickshaw Palanquin
            Dinghy Yacht Catamaran Hovercraft Icebreaker Tanker Barge Trawler Biplane
            Seaplane Zeppelin Blimp Rover Lander Shuttle Snowmobile Unicycle Tricycle
            Moped Caravan Hearse Coupe Sedan Roadster Speedboat Houseboat Tugboat
        ...
        "product": words("""
            ...
            Microphone Drone Tablet Smartphone Charger Battery Remote Fridge Washer
            Vacuum Heater Cooler Purifier Toaster Blender Oven Microwave Television
            Humidifier Razor Toothbrush Shampoo Perfume Lipstick Sneakers Wristwatch
            Console Projector Router Modem Scanner Webcam Joystick Gamepad Powerbank
            Amplifier Turntable Grinder Fryer Steamer Dishwasher Dryer Hairdryer Lotion
            Sunscreen Doorbell Thermostat Nightlight Calculator
            Whiteboard Socket Adapter Lightbulb Extension Stapler Organizer Diffuser
        ...
        "tech": words("""
            ...
            Heap Pointer Compiler Runtime Firmware Registry Bandwidth Latency Gateway
            Firewall Subnet Hostname Payload Checksum Schema Cursor Backup Cluster Shard
            Replica Snapshot Container Sandbox Pipeline Repository Commit Debugger Macro
            Array Matrix Boolean Integer Syntax Parser Lexer Bytecode Assembler
            Instruction Interrupt Register Bitrate Throughput Handshake Namespace
        ...
        "weather": words("""
            ...
            Thunder Downpour Monsoon Typhoon Whirlwind Zephyr Squall Drizzle Snowdrift
            Hoarfrost Sleet Cloudburst Gale Gust Cyclone Blizzard Hailstone Sunbeam
            Mirage Halo Raindrop Shower Stormcloud Rainstorm Snowstorm Sandstorm
            Duststorm Hurricane Tornado Twister Tempest Deluge Torrent Flurry Sprinkle
            Fogbank Smog Haze Humidity Forecast Overcast Sunshine Heatwave Coldsnap
            Chill Thaw Slush Rime Graupel Whiteout Windchill Crosswind Headwind Tailwind
        ...
        "space": words("""
            ...
            Universe Planet Satellite Asteroid Nebula Orbit Gravity Sunspot Crater
            Lightyear Cosmos Starfield Stardust Supernova Blackhole Quasar Pulsar
            Milkyway Crescent Fullmoon Newmoon Halfmoon Moonrise Void Ether Firmament
        ...
        "emotion": words("""
            ...
            Gratitude Humility Patience Diligence Prudence Temperance Fortitude
            Integrity Sincerity Wonder Awe Serenity Friendship Fellowship Solidarity
            Rivalry Reverie Joy Sorrow Anger Fear Surprise Delight Glee Cheer Bliss
            Elation Euphoria Rapture Comfort Relief Despair Grief Melancholy Gloom
        ...
        "body": words("""
            ...
            Tooth Gum Ear Earlobe Neck Nape Shoulder Elbow Wrist Knuckle Finger Thumb
            Fingernail Fist Chest Rib Belly Navel Spine Waist Hip Thigh Knee Shin Calf
            Ankle Heel Toe Toenail Skull Muscle Tendon Ligament Joint Cartilage Heart
            Lung Liver Stomach Kidney Spleen Intestine Bladder Brain Nerve Vein Artery
            Capillary Blood Flesh Skin Pore Hair Beard Tear Sweat Saliva Breath Pulse
        ...
        "clothing": words("""
            ...
            Silk Cotton Wool Velvet Corduroy Tweed Flannel Leather Fleece Beret Bonnet
        ...
        "toy": words("""
            ...
            Boomerang Chess Checkers Domino Backgammon Bingo Poker Solitaire Charades Hopscotch
            Peekaboo Leapfrog Hangman Tictactoe Sudoku Crossword Trivia Mahjong Roulette Pinata
            Slide Swing Seesaw Carousel Sandpit Sandcastle Trampoline Dollhouse Puppet Marionette
            Rattle Hobbyhorse Pogostick Stilts Jumprope Hulahoop Pinwheel Whirligig Figurine Spinner
            Snowglobe Bubble Slingshot Pinball Foosball Origami Rubberduck Trainset Toysoldier
            Glowstick Sparkler Confetti
        """),
        "sound": words("""
            Sound Noise Voice Silence Tone Whisper Murmur Shout Yell Scream Shriek Screech Cry Sob
            Wail Whimper Sigh Gasp Groan Moan Grunt Snort Laughter Giggle Chuckle Cackle Hum Buzz
            Hiss Rustle Whir Roar Growl Howl Snarl Woof Purr Meow Moo Oink Quack Cluck Neigh Bleat
            Croak Ribbit Squeak Squeal Tweet Chirp Trill Warble Coo Caw Hoot Yodel Rumble Thud Thump
            Bang Boom Crash Clang Clatter Clink Jingle Ding Peal Beep Honk Click Tick Knock Patter
            Footstep Thunderclap Applause Clap Hiccup Sneeze Cough Yawn Burp Snore Babble Chatter
            Mumble Splash Plop Crunch Crackle Sizzle Fizz Pop Whoosh Swish Ping Zap Drip Trickle
            Gurgle Twang Static Din Clamor Uproar Hubbub Commotion
        """),
        "person": words("""
            Person Human Child Baby Newborn Toddler Kid Boy Girl Teenager Youngster Adult Elder Man
            Woman Lady Gentleman Mother Father Parent Son Daughter Brother Sister Sibling Twin
            Grandmother Grandfather Grandchild Uncle Aunt Nephew Niece Cousin Husband Wife Bride
            Groom Widow Orphan Ancestor Relative Neighbor Friend Companion Rival Enemy Stranger
            Guest Host Visitor Newcomer Villager Citizen Roommate Classmate Teammate Playmate
            Spectator Bystander Passerby Witness Customer Patient Passenger Tourist Nomad Pioneer
            Hermit Loner Outcast Refugee Outlaw Prisoner Beggar Hero Heroine Villain Rascal
            Prankster Sleepyhead Bookworm Daydreamer Dreamer Genius Fool Coward Bully Brat Crybaby
            Tattletale Braggart Chatterbox Gossip Grouch Optimist Pessimist Romantic Rebel Leader
            Boss Veteran Beginner Expert Winner Loser Volunteer Lad Lass Maiden Daredevil
            Sleepwalker Castaway Sweetheart
        """),
        "furniture": words("""
            Cushion Quilt Mattress Curtain Wardrobe Bookshelf Nightstand Recliner Beanbag Footstool
            Ottoman Bedframe Duvet Bedsheet Pillowcase Chair Desk Bed Sofa Table Stool Bench Shelf
            Drawer Cradle Crib Cot Hammock Rug Carpet Blanket Pillow Bolster Lampshade Chandelier
            Sconce Candlestick Candelabra Vase Urn Frame Cabinet Cupboard Dresser Bureau Sideboard
            Armchair Rocker Loveseat Futon Daybed Bunkbed Headboard Bedpost Bedspread Tablecloth
            Doily Rack Hatstand Mantelpiece Bookend Toybox Hamper Shutter Valance Tapestry Wallpaper
            Highchair Playpen Bassinet Divan Armoire Pew Throne Locker
        """),
    },
    parts=words("""
    ...
    levels=WordLevels(
        basic=words("""
            Lion Tiger Leopard Cheetah Fox Wolf Bear Panda Rabbit Squirrel Cat Puppy Whale Dolphin
            Shark Turtle Seal Penguin Owl Eagle Swan Duck Goose Parrot Peacock Horse Deer Elephant
            Giraffe Hippo Monkey Gorilla Frog Lizard Snake Butterfly Bee Ladybug Snail Ant Spider
            Octopus Starfish Crab Shrimp Salmon Camel Koala Bat Zebra Buffalo Jellyfish Donkey Pony
            Lamb Kitten Beetle Bottle Pencil Eraser Umbrella Lamp Clock Mirror Keyring Padlock Cap
            Boot Goggles Button Thread Brush Paint Paper Notebook Bookmark Letter Postcard Compass
            Telescope Camera Radio Balloon Kite Marbles Dice Card Puzzle Blocks Anchor Tent Backpack
            Torch Candle Kettle Spoon Plate Magnet Ribbon Envelope Cushion Basket Broom Whistle Knot
            Bucket File Folder Paperclip Bolt Screw Chain Rope Zipper Badge Jar Sky Wave Tide Ocean
            River Lake Waterfall Mountain Hillside Meadow Forest Desert Boulder Pebble Volcano
            Earthquake Glacier Canyon Echo Shadow Avalanche Treetop Leaf Blossom Petal Seedling
            Berry Moss Fern Bamboo Pinecone Maple Dandelion Sunflower Lotus Orchid Tulip Lavender
            Pine Oak Acorn Chestnut Walnut Sprout Stem Twig Bark Bud Pollen Nectar Cactus Seaweed
            Hedge Vine Olive Palm Basil Parsley Gold Silver Copper Iron Steel Bronze Brass Tin
            Platinum Crystal Sapphire Emerald Marble Coral Chalk Diamond Freedom Peace Justice Truth
            Wisdom Memory Story Poem Grammar Physics Chemistry Biology Mathematics History Legend
            Riddle Secret Promise Journey Adventure Discovery Experiment Question Answer Festival
            Balance Culture Language Alphabet Calendar Symbol Tradition Ceremony Dragon Phoenix
            Goblin Troll Elf Dwarf Fairy Mermaid Ogre Demon Angel Ghost Vampire Werewolf Zombie
            Mummy Unicorn Genie Spell Curse Potion Witch Nightmare Portal Charm Blessing Wizard
            Thief Pirate Sailor Captain Chef Gardener Poet Painter Dancer Clown Warrior Soldier
            Guard Queen Prince Princess Emperor Servant Maid Farmer Pilot Engineer Firefighter
            Officer Doctor Nurse Teacher Student Librarian Reporter Writer Singer Actor Director
            Miner Carpenter Priest Inventor Explorer Traveler Athlete Referee Piano Guitar Drum
            Melody Rhythm Chord Lullaby Flute Clarinet Trumpet Saxophone Harp Cello Violin Harmonica
            Xylophone Tambourine Cymbal Organ Chorus Duet Orchestra Choir Conductor Verse Scale Key
            Sheet Pedal Bow String Market Village Bridge Garden Library Museum Theater Schoolyard
            Harbor Pier Station Airport Lighthouse Palace Temple Tower Attic Rooftop Balcony
            Greenhouse Barn Cottage Cabin Bakery Kitchen Bedroom Hallway Staircase Tunnel Playground
            Stadium Clinic Pharmacy Bookshop Aquarium Basement Lobby Workshop Studio Windmill
            Warehouse Campsite Crossroads Roundabout Rice Porridge Noodle Dumpling Bread Toast
            Cheese Yogurt Omelet Pancake Waffle Doughnut Cookie Biscuit Cupcake Brownie Pudding
            Pastry Croissant Bagel Pretzel Sandwich Burger Pizza Pasta Spaghetti Lasagna Curry Stew
            Salad Pickle Sausage Bacon Steak Meatball Barbecue Taco Burrito Sushi Tofu Potato Carrot
            ...
            Lemonade Popcorn Muffin Ramen Cheesecake Soccer Football Baseball Basketball Volleyball
            Tennis Badminton Golf Bowling Swimming Marathon Sprint Gymnastics Taekwondo Judo Karate
            Boxing Wrestling Sailing Surfing Skiing Snowboard Hockey Rugby Cricket Cycling Climbing
            Racket Medal Trophy Champion Skating Diving Jogging Relay Scoreboard Penalty Halftime
            Kickoff Homerun Dunk Somersault Cartwheel Handstand Backflip Warmup Timeout Bicycle Boat
            Bus Taxi Truck Motorbike Scooter Skateboard Airplane Helicopter Spaceship Rocket
            Submarine Sailboat Raft Kayak Ferry Wagon Cart Tractor Bulldozer Firetruck Ambulance
            Subway Sleigh Parachute Minivan Pickup Limousine Yacht Shuttle Tricycle Trailer Laptop
            Computer Keyboard Monitor Printer Speaker Earbuds Headphone Microphone Drone Tablet
            ...
            Hanger Bookshelf Pillowcase Apricot Mustard Lime Mint Navy Plum Rust Cream Beige
            Charcoal Jet Blonde Ginger Bone Smoke Denim Wine Brick Clay Sand Straw Powder Ice Ash
            Coal Cinnamon Wheat Receipt Share Interest Loan Deposit Savings Account Budget Capital
            Profit Debt Credit Check Exchange Refund Wage Salary Bonus Coupon Vault Withdrawal
            Statement Allowance Expense Discount Server Buffer Pixel Packet Queue Stack Cursor
            Backup Cluster Snapshot Container Pipeline Commit Array Matrix Instruction Register
            Texture Broadcast Directory Cloud Breeze Rain Snow Frost Icicle Mist Rainbow Sunset
            Lightning Thunder Typhoon Drizzle Blizzard Raindrop Shower Rainstorm Snowstorm Sandstorm
            Hurricane Tornado Smog Humidity Forecast Sunshine Heatwave Chill Snowflake Star Moon
            Galaxy Comet Meteor Starlight Moonbeam Eclipse Universe Planet Satellite Asteroid Orbit
            Gravity Crater Blackhole Milkyway Fullmoon Newmoon Halfmoon Skyline Astronomy Equator
            Sunrise Dawn Dusk Season Moment Holiday Morning Noon Afternoon Evening Night Midnight
            Midday Yesterday Today Tomorrow Weekday Weekend Decade Century Instant Springtime
            Summertime Winter Daytime Nighttime Lifetime Childhood Youth Nowadays Courage Curiosity
            Patience Wonder Friendship Joy Anger Fear Surprise Delight Cheer Comfort Relief Sadness
            Loneliness Regret Guilt Shame Pride Envy Jealousy Greed Passion Warmth Kindness Trust
            Doubt Worry Anxiety Terror Panic Rage Boredom Excitement Confidence Bravery Emotion Mood
            Temper Head Forehead Eyebrow Eyelash Eyelid Nose Cheek Chin Jaw Lip Tongue Tooth Gum Ear
            Neck Shoulder Elbow Wrist Knuckle Finger Thumb Fingernail Fist Chest Rib Belly Spine
            Waist Hip Thigh Knee Ankle Heel Toe Toenail Skull Muscle Heart Lung Liver Stomach Kidney
            Brain Blood Skin Hair Beard Tear Sweat Breath Pulse Heartbeat Backbone Kneecap Eyeball
            Wrinkle Freckle Dimple Scar Bruise Blister Glove Scarf Bathrobe Coat Jacket Shirt Blouse
            Trousers Jeans Shorts Skirt Dress Gown Vest Cardigan Sweater Jumper Hoodie Sock Tights
            Underwear Pajamas Apron Necktie Bowtie Belt Sneaker Sandal Slipper Uniform Costume Robe
            Raincoat Swimsuit Overalls Sleeve Collar Fabric Silk Cotton Wool Leather Helmet Hat Shoe
            Glasses Boots Mitten Shovel Ladder Wrench Pliers Level Ruler Scissors Needle Punch
            Hammer Drill Sandpaper Plane Pickaxe Rake Screwdriver Crowbar Lever Wedge Grater Spade
            Handle Blade Toolkit Toolbox Chainsaw Axe Saw Coffee Cocoa Water Soda Cider Smoothie
            Milkshake Latte Espresso Cappuccino Beer Whiskey Vodka Rum Tequila Gin Cocktail
            Champagne Icewater Hotwater Milk Juice Tea Sparkling
            Toy Game Doll Teddybear Ball Yoyo Frisbee Chess Checkers Domino Bingo Poker Hopscotch
            Peekaboo Slide Swing Seesaw Carousel Sandcastle Trampoline Dollhouse Puppet Rattle
            Jumprope Hulahoop Bubble Sound Noise Voice Silence Whisper Shout Yell Scream Cry Sigh
            Laughter Giggle Hum Buzz Roar Woof Meow Moo Oink Quack Squeak Bang Boom Crash Beep Honk
            Click Knock Applause Clap Hiccup Sneeze Cough Yawn Burp Snore Splash Pop Drip Person
            Human Child Baby Toddler Kid Boy Girl Teenager Adult Man Woman Lady Gentleman Mother
            Father Parent Son Daughter Brother Sister Twin Grandmother Grandfather Uncle Aunt Nephew
            Niece Cousin Husband Wife Bride Groom Neighbor Friend Enemy Stranger Guest Visitor
        ...
        rare=words("""
            ...
            Sandpiper Plover Lapwing Warbler Hoopoe Macaque Spindle Bedroll Cogwheel Mainspring
            Bobbin Rasp Inkpot Nib Blotter Steppe Atoll Headland Isthmus Islet Mesa Butte Crevasse
            Moraine Scree Talus Shoal Fumarole Karst Crag Rootlet Cowslip Columbine Larkspur Zinnia
            Freesia Alder Frond Bulrush Sedge Larch Linden Duckweed Wormwood Foxtail Sepal Stamen
            Pistil Calyx Rhizome Tuber Arbor Bough Gladiolus Oleander Blackthorn Delphinium Lupine
            Aster Ranunculus Gorse Bracken Horsetail Liverwort Sorrel Marjoram Tarragon Carnelian
            Peridot Zircon Malachite Lapis Mica Pyrite Gypsum Tourmaline Tanzanite Sunstone
            Bloodstone Azurite Chalcedony Citrine Morganite Kunzite Spinel Alexandrite Chrysoprase
            Rhodonite Sodalite Labradorite Amazonite Aventurine Hematite Magnetite Galena Bauxite
            Cinnabar Realgar Orpiment Barite Celestite Apatite Beryl Corundum Olivine Pyroxene
            Amphibole Serpentine Chlorite Kaolin Bentonite Zeolite Antimony Bismuth Cadmium Iridium
            Osmium Palladium Rhodium Ruthenium Tantalum Niobium Vanadium Tellurium Germanium Gallium
            Indium Thallium Rubidium Caesium Strontium Barium Almanac Axiom Corollary Allegory Annal
            Covenant Catharsis Wyvern Cockatrice Manticore Satyr Seraph Djinn Grimoire Revenant Lich
            Wyrm Dryad Naiad Gorgon Faun Norn Augur Sigil Glyph Portent Homunculus Kobold Ifrit
            Barghest Selkie Kelpie Wendigo Roc Simurgh Undine Sylph Efreet Marid Naga Rakshasa Oni
            Tengu Kitsune Kappa Bunyip Lindworm Amphisbaena Catoblepas Peryton Scrying Ley Reliquary
            Phylactery Warding Coachman Minstrel Cavalier Stonecutter Conservator Actuary
            Philologist Typesetter Notary Underwriter Draftsman Millwright Machinist Fitter Rigger
            Glazier Upholsterer Cobbler Milliner Dyer Tanner Glassblower Silversmith Luthier
            Perfumer Vintner Kalimba Zither Nocturne Etude Fugue Cantata Oratorio Madrigal Coda
            Diminuendo Legato Tremolo Glissando Arpeggio Semitone Stave Soundhole Syncopation
            Toccata Partita Minuet Mazurka Bolero Chorale Motet Ostinato Consonance Cadenza Backbeat
            Timbre Contralto Descant Obbligato Byway Esplanade Larder Meadowland Pastureland
            Farmstead Belfry Cloister Rampart Quay Rotunda Colonnade Portico Agora Necropolis
            Cenotaph Weir Congee Bisque Consomme Terrine Kendo Biathlon Velodrome Pommel Palanquin
            Dredger Palfrey Skiff Sampan Coracle Outrigger Turboprop Sailplane Autogyro Tiltrotor
            Halftrack Snowcat Railbus Percolator Slipmat Vermilion Carmine Cerise Ocher Umber
            Chartreuse Cerulean Ultramarine Viridian Bister Ecru Puce Russet Sable Gamboge Verdigris
            Celadon Escrow Levy Annuity Lien Bullion Exchequer Remittance Arbitrage Debenture
            Passbook Guarantor Liquidity Solvency Outlay Arrears Daemon Subnet Hostname Checksum
            Boolean Parser Lexer Bytecode Assembler Throughput Namespace Middleware Webhook Hashing
            Salting Sharding Rasterizer Shader Viewport Framebuffer Bitfield Octet Downlink
            Multicast Datagram Bootloader Symlink Zephyr Squall Hoarfrost Rime Graupel Nimbus Cirrus
            Stratus Quasar Pulsar Firmament Perihelion Aphelion Apogee Perigee Nadir Azimuth
            Parallax Redshift Starlore Telescopy Lunation Sidereal Ecliptic Solarsail Aeon Dotage
            Dayspring Eventide Forenoon Gloaming Nightlong Sennight Vesper Springtide Wintertide
            Autumntide Prudence Temperance Fortitude Reverie Rapture Ardor Fervor Timidity Gladness
            Mirth Levity Rancor Wistfulness Sinew Espadrille Brogue Kerchief Petticoat Bodice
            Doublet Kaftan Topcoat Awl Caliper Plumbline Chalkline Adze Whetstone Harrow Flail
            Rivetgun Lathe Ripsaw Coping Gouge Burin Scriber Setsquare Tsquare Bevel Jointer Miter
            Ballpeen Screwjack Pincer Bradawl Burnisher Drawknife Spokeshave Miterbox Nailset
            Plumbbob Ristretto Digestif Grog Wassail Sweetwater Nitrobrew Curacao Ouzo Raki Arrack
            Verjuice Switchel Barleywater Ricewater
            Backgammon Solitaire Charades Mahjong Roulette Marionette Hobbyhorse Pogostick Whirligig
            Figurine Snowglobe Foosball Origami Toysoldier Glowstick Murmur Shriek Screech Whimper
            Cackle Whir Snarl Bleat Ribbit Trill Warble Caw Yodel Clang Clatter Clink Peal Patter
            Thunderclap Babble Plop Crackle Gurgle Twang Static Din Clamor Uproar Hubbub Commotion
            Newborn Youngster Sibling Grandchild Ancestor Companion Villager Citizen Spectator
            Bystander Passerby Nomad Pioneer Hermit Outcast Refugee Outlaw Heroine Rascal Prankster
            Braggart Grouch Optimist Pessimist Veteran Lad Lass Maiden Daredevil Sleepwalker
