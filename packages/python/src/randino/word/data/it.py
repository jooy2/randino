...
_POOLS, _GENDER = tagged_nouns(
    ...
    """,
        ...
        biglia:f dado:m carta_gioco:f puzzle:m vela:f ancora:f tenda:f torcia:f
    ...
    """,
        ...
        castagno:m noce:m prato_verde:m alga:f siepe:f mazzo:m cactus:m aloe:f
    ...
    """,
        ...
        fossato:m cantiere:m molo_lungo:m accampamento:m villa:f dimora:f borgo:m
    """,
        "food": """
    ...
    """,
        ...
        cricket:m ciclismo:m arrampicata:f racchetta:f mazza_gioco:f porta:f medaglia:f
        trofeo:m campione:m finale_sport:f eliminatoria:f allenamento:m polo:m
        pattinaggio:m tuffo:m freccetta:f ostacolo:m giavellotto:m disco:m staffetta:f
        tabellone:m casco:m fallo:m dorso:m rana_stile:f sollevamento:m slitta:f
    ...
    """,
        ...
        ambrato:m ocra:f seppia:f senape:f oliva_colore:f lime_colore:m smeraldino:m
        turchese:m ciano:m celeste:m indaco:m lilla:m malva_colore:f violetto:m
    ...
    """,
        ...
        salvataggio:m garanzia:f buono:m coupon:m lingotto_oro:m cassaforte:f
    ...
    """,
        ...
        pila_dati:f cumulo:m puntatore:m compilatore:m firmware:m registro:m latenza:f
        ...
        handshake:m spazio_nomi:m endpoint:m cifratura:f decifratura:f hashing:m
    ...
    """,
        "space": """
        stella:f luna:f sole_astro:m galassia:f cometa:f meteora:f aurora:f
    ...
    """,
        "time": """
        alba:f aurora_ora:f crepuscolo:m tramonto_ora:m imbrunire:m solstizio:m
        ...
        alba_presto:f vigilia:f ieri:m oggi:m giornata:f settimana:f quindicina:f mese:m
        trimestre:m semestre:m anno:m lustro:m millennio:m epoca:f era:f età:f
        primavera:f estate:f autunno:m inverno:m antico_tempo:m adesso:m poi:m
    ...
    """,
        ...
        mascella:f labbro:m lingua_bocca:f dente:m gengiva:f orecchio:m lobo:m collo:m
    ...
    """,
        "tool": """
        ascia:f pala:f sega:f scala_mano:f pinza:f scalpello:m incudine:f mantice:m
    ...
    """,
        ...
        rosso_vino:m bianco_vino:m rosato_vino:m spumante:m prosecco:m champagne:m
        sherry:m porto_vino:m vermut:m sangria:f liquore:m grappa:f acquavite:f rum:m
