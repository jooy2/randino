...
def rand_gem(
    *,
    ...
    `rand_word(theme="gem")` with the theme already chosen; every other argument
    ...
    Example:
        >>> rand_gem(language="ko", count=3)
        ['금', '수정', '흑요석']
        >>> rand_gem(language="en", count=3)
        ['Gold', 'Quartz', 'Obsidian']
    """
    theme: WordThemeOption = "gem"
