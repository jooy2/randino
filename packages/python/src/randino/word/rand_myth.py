...
def rand_myth(
    *,
    ...
    `rand_word(theme="myth")` with the theme already chosen; every other argument
    ...
    Example:
        >>> rand_myth(language="ko", count=3)
        ['용', '봉황', '구미호']
        >>> rand_myth(language="en", count=3)
        ['Dragon', 'Phoenix', 'Griffin']
    """
    theme: WordThemeOption = "myth"
