...
def rand_person(
    *,
    ...
    `rand_word(theme="person")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_person(language="ko", count=3)
        ['꼬마', '이웃', '손님']
        >>> rand_person(language="en", count=3)
        ['Toddler', 'Neighbor', 'Stranger']
    """
    theme: WordThemeOption = "person"
