...
def rand_food(
    *,
    ...
    `rand_word(theme="food")` with the theme already chosen; every other argument
    ...
    Example:
        >>> rand_food(language="ko", count=3)
        ['밥', '떡볶이', '빵']
        >>> rand_food(language="en", count=3)
        ['Rice', 'Noodle', 'Dumpling']
    """
    theme: WordThemeOption = "food"
