...
def rand_clothing(
    *,
    ...
    `rand_word(theme="clothing")` with the theme already chosen; every other argument
    is the same.
    ...
    Example:
        >>> rand_clothing(language="ko", count=3)
        ['두루마기', '양말', '외투']
        >>> rand_clothing(language="en", count=3)
        ['Cardigan', 'Mitten', 'Overcoat']
    """
    theme: WordThemeOption = "clothing"
