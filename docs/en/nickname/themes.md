...
```python
from randino import NICKNAME_THEMES, random_nickname

NICKNAME_THEMES
# ('animal', 'object', 'nature', 'plant', 'gem', 'concept', 'myth', 'job',
#  'music', 'place', 'food', 'sport', 'vehicle', 'product')

random_nickname(theme="food", language="ko", count=3)
# ['달콤한떡볶이', '고소한녹차', '새콤한딸기']
```
