...
Returns `List<String>`. For the detail form, pass `WordTheme.product` to `randWordDetails` — Dart has no overloads, and fourteen more functions for it would be fourteen too many.
