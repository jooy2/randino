...
Returns `List<String>`. For the detail form, pass `WordTheme.product` to `randWordDetails` — Dart has no overloads, and seventeen more functions for it would be seventeen too many.
