...
Returns `List<String>`. For the detail form, pass `WordTheme.food` to `randWordDetails` — Dart has no overloads, and seventeen more functions for it would be seventeen too many.
