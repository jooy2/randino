...
Returns `List<String>`. For the detail form, pass `WordTheme.drink` to `randWordDetails` — Dart has no overloads, and twenty-four more functions for it would be twenty-four too many.
