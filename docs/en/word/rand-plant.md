...
Returns `List<String>`. For the detail form, pass `WordTheme.plant` to `randWordDetails` — Dart has no overloads, and twenty-five more functions for it would be twenty-five too many.
