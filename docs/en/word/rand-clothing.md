...
Returns `List<String>`. For the detail form, pass `WordTheme.clothing` to `randWordDetails`. Dart has no overloads, and a detail twin for each of the twenty-five themes would be twenty-five functions too many.
