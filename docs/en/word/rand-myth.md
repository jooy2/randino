...
Returns `List<String>`. For the detail form, pass `WordTheme.myth` to `randWordDetails`. Dart has no overloads, and a detail twin for each of the twenty-nine themes would be twenty-nine functions too many.
