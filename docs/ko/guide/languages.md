...
문장도 아홉 언어가 모두 씁니다. 각 언어는 자기 문법이 감당할 수 있는 형태를 선언하며, 언어마다 다른 것은 동사가 어디에 서는지, 구를 무엇으로 표시하는지, 그리고 어떤 형태를 아예 쓸 수 없는지입니다.
...
독일어와 러시아어가 좁은 이유는 같습니다. 둘 다 목적어는 대격에, 장소는 또 다른 격에 두어야 하는데, 격마다 명사 자체의 어미나 앞의 관사가 바뀌므로 그런 형태는 아예 선언하지 않습니다. 그런 요청은 가진 것 중 가장 가까운 형태로 되돌아갑니다. 자세한 내용은 [문장](../sentence/)에 있습니다.
