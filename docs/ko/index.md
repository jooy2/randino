...
title: randino
titleTemplate: 원하는 언어로 만드는 무작위 이름, 닉네임, 단어, 문장
...
hero:
  ...
  tagline: 사람 이름과 닉네임, 일상 단어, 완결된 문장을 9개 언어로 만듭니다. JavaScript, Dart, Python용 라이브러리 하나이며 런타임 의존성이 없습니다.
  actions:
    - theme: brand
      text: 시작하기
...
features:
  ...
  - title: 일상 단어로 만드는 닉네임
    ...
    linkText: 닉네임
  - title: 테마별 단어
    details: 테마 25개마다 함수가 하나씩 있습니다. randAnimal, randFood, randGem처럼, 닉네임을 만드는 어휘를 그대로 꺼내 씁니다.
    link: /ko/word/rand-word
    linkText: randWord
  - title: 문법을 갖춘 문장
    details: 동사가 무엇이 그 행위를 할 수 있고 무엇에 할 수 있는지 밝히므로, 한 문장의 단어가 서로 어울립니다. 조사와 관사와 어순은 각 언어의 것입니다.
    link: /ko/sentence/
    linkText: 문장
...
모든 옵션은 선택 사항이라, 인자 없이 호출하면 9개 언어 중 하나로 이름 하나를 돌려줍니다. 각 옵션이 하는 일은 [사람 이름](./name/)과 [닉네임](./nickname/)에, 설치 방법은 [시작하기](./guide/getting-started)에 있습니다.
